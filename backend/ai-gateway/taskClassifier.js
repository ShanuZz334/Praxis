...
export function classifyTask(taskType) {
    ...
    const LEVEL_3 = ['chat_conversation', 'page_header_insight', 'options_oi_interpretation', 'analyst_brief'];
    const LEVEL_4 = ['page_synthesis', 'stock_narrative', 'report_generation', 'strategy_suggestion', 'journal_behavioral_patterns', 'macro_cycle_assessment', 'journal_insight'];

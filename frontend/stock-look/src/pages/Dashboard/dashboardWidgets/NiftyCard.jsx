  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 items-center">
        <h2 className="text-lg font-semibold text-white">NIFTY 50</h2>
      ...
      <div className="space-y-1 text-white/80 text-sm">
        <div className="flex justify-between">
          ...
          <span>₹ {data.prevClose}</span>
        </div>
        <div className="flex justify-between">
          <span>Prev Open:</span>
          <span>₹ {data.prevOpen}</span>
        </div>
        <div className="flex justify-between">
          <span>Prev High:</span>
          <span>₹ {data.prevHigh}</span>
        </div>
        <div className="flex justify-between">
          <span>Prev Low:</span>
          <span>₹ {data.prevLow}</span>
        </div>
      </div>

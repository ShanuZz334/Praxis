export const CARD_REGISTRY = {
    ...
    pe_ratio: {
        ...
        aliases: ['pe ratio', 'p/e ratio', 'p/e', 'trailing p/e ratio', 'trailing pe'],
        page: 'Fundamentals',
        section: 'Valuation',
        appliesTo: 'equity',
        legacyIds: ['pe']
    ...
    nifty_pe: { id: 'nifty_pe', type: 'card', displayName: 'Nifty P/E', aliases: ['index p/e'], page: 'Fundamentals', section: 'Valuation', appliesTo: 'indices', legacyIds: [] },
    nifty_pb: { id: 'nifty_pb', type: 'card', displayName: 'Nifty P/B', aliases: ['index p/b'], page: 'Fundamentals', section: 'Valuation', appliesTo: 'indices', legacyIds: [] },
    mcap_gdp: { id: 'mcap_gdp', type: 'card', displayName: 'M-Cap to GDP', aliases: ['market cap / gdp', 'mcap / gdp'], page: 'Fundamentals', section: 'Valuation', appliesTo: 'indices', legacyIds: ['market_cap_gdp'] },
    ...
    gdp: { id: 'gdp', type: 'card', displayName: 'GDP Growth', aliases: ['index gdp'], page: 'Fundamentals', section: 'Macro', appliesTo: 'indices', legacyIds: [] },
    cpi: { id: 'cpi', type: 'card', displayName: 'CPI Inflation', aliases: ['cpi'], page: 'Fundamentals', section: 'Macro', appliesTo: 'indices', legacyIds: [] },
    ...
    cash_conversion: { id: 'cash_conversion', type: 'card', displayName: 'Cash Conv. Cycle', aliases: ['cash conversion', 'cash conversion cycle', 'ccc'], page: 'Fundamentals', section: 'General', appliesTo: 'company', legacyIds: [] },
    ...
    shareholding_trend: {
        ...
        type: 'card',
        displayName: 'Shareholding Trend',
        aliases: ['shareholding', 'shareholding pattern', 'fii dii trend', 'institutional holding', 'promoter trend'],
        page: 'Fundamentals',
        section: 'Ownership',
        appliesTo: 'company',
        legacyIds: []
    ...
    peer_multiples: {
        id: 'peer_multiples',
        type: 'card',
        displayName: 'Sector Peer Multiples',
        aliases: ['peer multiples', 'peers', 'peer comparison', 'industry peers', 'sector peers'],
        page: 'Fundamentals',
        section: 'Valuation',
        appliesTo: 'company',
        legacyIds: []
    ...
    historical_financials: {
        ...
        type: 'card',
        displayName: '10Y Financial Statements',
        aliases: ['financial statements', '10y statements', 'profit and loss', 'balance sheet', 'cash flow', 'historical statements', 'cagr growth'],
        page: 'Fundamentals',
        section: 'Corporate',
        appliesTo: 'company',
        legacyIds: []
    ...
    adx: { id: 'adx', type: 'card', displayName: 'ADX', aliases: ['adx', 'adx (14)', 'average directional index'], page: 'Technical', section: 'Trend', appliesTo: 'both', legacyIds: [] },
    supertrend: { id: 'supertrend', type: 'card', displayName: 'Supertrend', page: 'Technical', section: 'Trend', appliesTo: 'both', legacyIds: [] },
    beta_correlation: { id: 'beta_correlation', type: 'card', displayName: 'Beta (vs Nifty)', aliases: ['beta correlation', 'beta', 'correlation'], page: 'Technical', section: 'Trend', appliesTo: 'both', legacyIds: [] },

    // Momentum
    rsi: { id: 'rsi', type: 'card', displayName: 'RSI', aliases: ['rsi', 'rsi (14)', 'relative strength index'], page: 'Technical', section: 'Momentum', appliesTo: 'both', legacyIds: [] },
    ...
    stoch_rsi: { id: 'stoch_rsi', type: 'card', displayName: 'Stochastic RSI', aliases: ['stoch rsi'], page: 'Technical', section: 'Momentum', appliesTo: 'both', legacyIds: [] },

    // Volatility
    bb_20_2: { id: 'bb_20_2', type: 'card', displayName: 'Bollinger Bands', page: 'Technical', section: 'Volatility', appliesTo: 'both', legacyIds: [] },
    atr: { id: 'atr', type: 'card', displayName: 'Average True Range', aliases: ['atr'], page: 'Technical', section: 'Volatility', appliesTo: 'both', legacyIds: [] },
    kc: { id: 'kc', type: 'card', displayName: 'Keltner Channel', aliases: ['keltner channel', 'keltner', 'kc'], page: 'Technical', section: 'Volatility', appliesTo: 'both', legacyIds: [] },

    // Volume
    volume_sma: { id: 'volume_sma', type: 'card', displayName: 'Volume SMA (20)', aliases: ['volume sma', 'volume moving average'], page: 'Technical', section: 'Volume', appliesTo: 'both', legacyIds: [] },
    obv: { id: 'obv', type: 'card', displayName: 'On-Balance Volume (OBV)', aliases: ['obv', 'on balance volume'], page: 'Technical', section: 'Volume', appliesTo: 'both', legacyIds: [] },
    cmf: { id: 'cmf', type: 'card', displayName: 'Chaikin Money Flow', aliases: ['cmf', 'chaikin money flow (cmf)'], page: 'Technical', section: 'Volume', appliesTo: 'both', legacyIds: [] },
    ...
    // Structure
    support: { id: 'support', type: 'card', displayName: 'Support Level', aliases: ['support'], page: 'Technical', section: 'Structure', appliesTo: 'both', legacyIds: [] },
    resistance: { id: 'resistance', type: 'card', displayName: 'Resistance Level', aliases: ['resistance'], page: 'Technical', section: 'Structure', appliesTo: 'both', legacyIds: [] },
    ...
    fibonacci: { id: 'fibonacci', type: 'card', displayName: 'Fibonacci Retracement', aliases: ['fibonacci', 'fib'], page: 'Technical', section: 'Structure', appliesTo: 'both', legacyIds: [] },

    // Breadth
    breadth_ratio: { id: 'breadth_ratio', type: 'card', displayName: 'Market Breadth Ratio', aliases: ['breadth ratio (adr)', 'adr'], page: 'Technical', section: 'Breadth', appliesTo: 'indices', legacyIds: [] },
    ad_line: { id: 'ad_line', type: 'card', displayName: 'Advance / Decline Line', aliases: ['a/d line', 'ad line'], page: 'Technical', section: 'Breadth', appliesTo: 'indices', legacyIds: [] },
    nh_nl: { id: 'nh_nl', type: 'card', displayName: 'New High / New Low', aliases: ['new highs / lows', 'nh/nl', 'nh nl'], page: 'Technical', section: 'Breadth', appliesTo: 'indices', legacyIds: [] },
    ...
    // Volatility
    atm_iv: { id: 'atm_iv', type: 'card', displayName: 'At-the-Money Implied Volatility', aliases: ['atm iv', 'implied volatility', 'iv'], page: 'Options', section: 'Volatility', appliesTo: 'both', legacyIds: [] },
    iv_rank: { id: 'iv_rank', type: 'card', displayName: 'IV Rank', page: 'Options', section: 'Volatility', appliesTo: 'both', legacyIds: [] },

    // Open Interest
    oi_change: { id: 'oi_change', type: 'card', displayName: 'Open Interest Change', aliases: ['oi change'], page: 'Options', section: 'Open Interest', appliesTo: 'both', legacyIds: [] },
    total_call_oi: { id: 'total_call_oi', type: 'card', displayName: 'Total Call Open Interest', aliases: ['total call oi', 'call wall'], page: 'Options', section: 'Open Interest', appliesTo: 'both', legacyIds: [] },
    total_put_oi: { id: 'total_put_oi', type: 'card', displayName: 'Total Put Open Interest', aliases: ['total put oi', 'put floor'], page: 'Options', section: 'Open Interest', appliesTo: 'both', legacyIds: [] },
    ...
    pcr_oi: { id: 'pcr_oi', type: 'card', displayName: 'Put-Call Ratio (OI)', aliases: ['pcr oi', 'pcr'], page: 'Options', section: 'Put-Call Ratio', appliesTo: 'both', legacyIds: [] },
    pcr_volume: { id: 'pcr_volume', type: 'card', displayName: 'Put-Call Ratio (Volume)', aliases: ['pcr volume'], page: 'Options', section: 'Put-Call Ratio', appliesTo: 'both', legacyIds: [] },
    max_pain: { id: 'max_pain', type: 'card', displayName: 'Max Pain', page: 'Options', section: 'Market Positioning', appliesTo: 'both', legacyIds: [] },
    expected_move: { id: 'expected_move', type: 'card', displayName: 'Expected Move', aliases: ['em', 'straddle range'], page: 'Options', section: 'Market Positioning', appliesTo: 'both', legacyIds: [] },
    gex: { id: 'gex', type: 'card', displayName: 'Gamma Exposure (GEX)', aliases: ['net gamma', 'dealer gamma'], page: 'Options', section: 'Market Positioning', appliesTo: 'both', legacyIds: [] },
    ...
    dow_jones:        { id: 'dow_jones',        type: 'card', displayName: 'Dow Jones',         aliases: ['dow', 'dow futures', 'djia'], page: 'Foreign', section: 'US Markets', appliesTo: 'n/a', legacyIds: [] },
    ...
    crude:            { id: 'crude',            type: 'card', displayName: 'Crude Oil',         aliases: ['brent crude', 'crude', 'wti crude'], page: 'Foreign', section: 'Commodities',        appliesTo: 'n/a', legacyIds: ['brent_crude'] },
    ...
    ethereum:         { id: 'ethereum',         type: 'card', displayName: 'Ethereum',          aliases: ['eth', 'eth/usd'], page: 'Foreign', section: 'Digital Assets', appliesTo: 'n/a', legacyIds: [] },

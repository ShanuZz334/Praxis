import { Activity, BookOpen, Calculator, Clock, Database, Globe, Lightbulb, Scale, ShieldAlert, LineChart, Wallet, BookMarked, Target } from "lucide-react";
            ...
            },
{
          ...
          "description": "Calculates the unweighted mean of the previous N periods' closing prices, smoothing out price volatility to identify the prevailing trend.",
          "calculation": "Sum of closing prices over N periods divided by N.",
          "weight": "2% of Technical Engine",
          "interpretation": "Price above the SMA suggests an uptrend; price below suggests a downtrend. Crossovers between shorter and longer SMAs indicate trend changes.",
          "interpretationVisual": [
                    {
                              "range": "Price < SMA",
                              "label": "Bearish",
          ...
          "proTip": "Use a 200-day SMA as a macro trend filter; avoid taking long positions when the price is consistently trading below it.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle close",
          "confidenceImpact": "Moderate"
            },
{
          "id": "ema_exponential_moving_average",
          "title": "EMA (Exponential Moving Average)",
          "description": "A moving average that places a greater weight and significance on the most recent data points, reacting more significantly to recent price changes than the SMA.",
          "calculation": "(Close - Previous EMA) * Multiplier + Previous EMA. Multiplier = 2 / (N + 1).",
          "weight": "3% of Technical Engine",
          "interpretation": "Use the EMA to identify short-term trend directions faster than the SMA. A rising EMA indicates a bullish trend, while a falling EMA indicates a bearish trend.",
          "interpretationVisual": [
                    {
                              "range": "Price < EMA",
                              "label": "Downtrend",
          ...
          "proTip": "Combine an 8-period and 21-period EMA; a cross of the 8 over the 21 signals a strong entry point for short-term momentum trades.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per tick/candle",
          "confidenceImpact": "Moderate"
            },
{
          "id": "wma_weighted_moving_average",
          "title": "WMA (Weighted Moving Average)",
          "description": "Assigns a linearly decreasing weight to older prices, making it more responsive to recent price action while retaining historical context.",
          "calculation": "Sum of (Price * Weight) for N periods, divided by the sum of weights. Weights decrease linearly.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Track the WMA for a closer approximation of current momentum. Crossovers with price act as dynamic support or resistance.",
          "interpretationVisual": [
                    {
                              "range": "Price < WMA",
          ...
          "proTip": "The WMA is highly sensitive to price spikes; use it in conjunction with a volume indicator to validate the strength of a sudden breakout.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per tick",
          "confidenceImpact": "Moderate"
            },
{
          "id": "alma_arnaud_legoux_ma",
          "title": "ALMA (Arnaud Legoux MA)",
          "description": "Uses a Gaussian distribution curve to shift the moving average offset, reducing lag while maintaining a smooth line for trend following.",
          "calculation": "Weighted sum of closing prices using Gaussian weights defined by offset and sigma parameters.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Provides superior smoothness and responsiveness. Trade in the direction of the ALMA slope and use touches to the ALMA line as entry triggers in strong trends.",
          "interpretationVisual": [
                    {
                              "range": "Slope Down",
                              "label": "Strong Downtrend",
          ...
          "proTip": "Adjust the offset parameter to 0.85 to make the ALMA highly responsive for day trading without sacrificing its noise-filtering capabilities.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "kama_kaufman_adaptive_ma",
          "title": "KAMA (Kaufman Adaptive MA)",
          "description": "An intelligent moving average that automatically adjusts its speed based on market volatility, moving slowly during choppy markets and quickly during trends.",
          "calculation": "Previous KAMA + Smoothing Constant * (Price - Previous KAMA). Smoothing Constant is based on the Efficiency Ratio (ER).",
          "weight": "3% of Technical Engine",
          "interpretation": "A flat KAMA indicates market noise, suggesting traders should stand aside. A distinct upturn or downturn signals a tradable directional trend.",
          "interpretationVisual": [
                    {
                              "range": "Price < KAMA (Steep)",
                              "label": "Trend Down",
                              "color": "text-red-500"
                    },
                    {
                              "range": "KAMA Flat",
                              "label": "High Noise/Sideways",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Price > KAMA (Steep)",
          ...
          "proTip": "Use KAMA's flat sections to draw robust horizontal support/resistance zones that institutions often defend.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Designed to eliminate the lag associated with traditional EMAs by calculating an EMA of an EMA and subtracting the lag.",
          "calculation": "(2 * EMA(n)) - EMA(EMA(n)).",
          "weight": "2% of Technical Engine",
          "interpretation": "Excellent for catching early trend reversals. A DEMA crossover generates signals much earlier than an SMA or EMA, but with a higher risk of whipsaws.",
          "interpretationVisual": [
                    {
                              "range": "Price < DEMA",
                              "label": "Bearish",
                    ...
                    {
                              "range": "Price crossing DEMA",
                              "label": "Reversal Alert",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Price > DEMA",
          ...
          "proTip": "DEMA is prone to false signals in sideways markets; always pair it with the ADX (Average Directional Index) to ensure you are in a trending environment.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per tick",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Further reduces lag compared to DEMA by incorporating a triple-smoothed EMA formulation, keeping the indicator extremely tight to price.",
          "calculation": "(3 * EMA) - (3 * EMA(EMA)) + EMA(EMA(EMA)).",
          "weight": "2% of Technical Engine",
          "interpretation": "Reacts instantly to price shifts. Best used for scalping or short-term swing trading where entering at the exact point of reversal is critical.",
          "interpretationVisual": [
                    {
                              "range": "TEMA Falling",
                              "label": "Immediate Short",
                              "color": "text-red-500"
                    },
                    {
                              "range": "TEMA Flattening",
                              "label": "Momentum Loss",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "TEMA Rising",
                              "label": "Immediate Long",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Because TEMA hugs price so closely, use a break of the TEMA line on high volume as a definitive stop-loss trigger for momentum trades.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per tick",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Aims to completely eliminate lag from the moving average calculation by tracking prices closer than standard EMAs, tracking the 'de-lagged' data.",
          "calculation": "EMA of (Price + (Price - Price[n/2])).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Provides a real-time feel of market direction. Buy when ZLEMA turns up, sell when it turns down. Excellent for defining trailing stops.",
          "interpretationVisual": [
                    {
                              "range": "ZLEMA Downward",
                              "label": "Bearish Trend",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "ZLEMA's lack of lag makes it the ideal baseline for creating custom, zero-lag MACD oscillators for faster histogram divergences.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A combination of an SMA and an EMA, placing more weight on recent prices while retaining an extended historical base to filter out short-term fluctuations.",
          "calculation": "(Previous SMMA * (N - 1) + Current Price) / N.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "A highly stable trend-following tool. Best used for long-term macro trend identification rather than short-term entry/exit signals.",
          "interpretationVisual": [
                    {
                              "range": "Price way below SMMA",
                              "label": "Deep Bear",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Price near SMMA",
                              "label": "Mean Reversion",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Price way above SMMA",
                              "label": "Strong Bull",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Use the SMMA to trail stop-losses on position trades that you intend to hold for months, as it is highly resistant to standard market pullbacks.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Weights prices by their corresponding volume, giving more significance to price action that occurs on high volume.",
          "calculation": "Sum of (Price * Volume) for N periods / Sum of Volume for N periods.",
          "weight": "4% of Technical Engine",
          "interpretation": "A bullish crossover of the VWMA above an SMA of the same length confirms that the uptrend is supported by volume, increasing its validity.",
          "interpretationVisual": [
                    {
                              "range": "VWMA < SMA",
                              "label": "Low Volume Selloff",
                              "color": "text-red-500"
                    },
                    {
                              "range": "VWMA ~ SMA",
                    ...
                    {
                              "range": "VWMA > SMA",
                              "label": "High Volume Accumulation",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "When price is moving up but the VWMA is lagging below a standard SMA, it signals a 'hollow' rally lacking institutional volume support—prepare for a reversal.",
          "dataSources": "Price & Volume Data",
          "updateFrequency": "Per tick",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Adjusts its speed and weighting based on volume increments rather than time increments, filtering out periods of low liquidity.",
          "calculation": "Moving average calculated over a dynamic period where high volume bars are weighted heavily and low volume bars are ignored or down-weighted.",
          "weight": "3% of Technical Engine",
          "interpretation": "Reduces false signals during thinly traded sessions (e.g., overnight markets). Trade in the direction of the VAMA only when it has a clear slope.",
          "interpretationVisual": [
                    {
                              "range": "Downward VAMA",
                              "label": "Volume Selling",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Flat VAMA",
          ...
          "proTip": "VAMA is exceptionally useful in crypto markets for filtering out weekend price action, which often occurs on low volume and leads to Monday traps.",
          "dataSources": "Price & Volume Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "hma_hull_moving_average",
          "title": "HMA (Hull Moving Average - Fast)",
          "description": "An extremely fast and smooth moving average created by Alan Hull that eliminates almost all lag while retaining a very smooth curve.",
          "calculation": "WMA(2 * WMA(n/2) - WMA(n)), with a period of sqrt(n).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "A turning HMA is a very reliable signal of a short-term trend reversal. Buy when HMA turns up and turns green; sell when it turns down and turns red.",
          "interpretationVisual": [
                    {
                              "range": "HMA Slope Negative",
                              "label": "Bearish Turn",
                              "color": "text-red-500"
                    },
                    {
                              "range": "HMA Hooking",
                              "label": "Reversal Imminent",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "HMA Slope Positive",
                              "label": "Bullish Turn",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "The HMA is so fast that using crossovers can cause whipsaws. Instead, purely trade the color/slope change of a single, longer-period HMA (e.g., 55-period).",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per tick",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Utilizes fractal geometry to dynamically adjust its smoothing period based on the fractal dimension of price action, effectively distinguishing between trends and chop.",
          "calculation": "EMA formula where the smoothing constant alpha is derived from the Fractal Dimension of the price series.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "During ranging markets, FRAMA stays flat and acts as rigid support/resistance. During trends, it tightly follows price. Wait for a breakout from a flat FRAMA to enter.",
          "interpretationVisual": [
                    {
                              "range": "Price Below FRAMA",
                              "label": "Trending Down",
                              "color": "text-red-500"
                    },
                    {
                    ...
                    {
                              "range": "Price Above FRAMA",
                              "label": "Trending Up",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "FRAMA is incredible for identifying macro support levels; a prolonged flat FRAMA line often acts as a massive 'magnet' for price reversion before the next leg up.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "An adaptive moving average that dynamically adjusts its sensitivity based on the Chande Momentum Oscillator (CMO), speeding up as volatility increases.",
          "calculation": "EMA where the smoothing constant alpha is multiplied by the absolute value of the CMO.",
          "weight": "2% of Technical Engine",
          "interpretation": "A rising VIDYA suggests strong upward momentum backed by volatility. Excellent for trailing stops because it immediately flattens out when momentum dies.",
          "interpretationVisual": [
                    {
                              "range": "VIDYA Dropping",
          ...
          "proTip": "Combine VIDYA with standard Bollinger Bands. When VIDYA breaks outside the bands, it signals a hyper-volatile trend expansion—do not fade these moves.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          "id": "envelopes",
          "title": "Envelopes",
          "description": "Two bands placed above and below a moving average at a fixed percentage, designed to identify overbought and oversold extremes.",
          "calculation": "Upper Band = MA * (1 + Percentage); Lower Band = MA * (1 - Percentage).",
          "weight": "1.5% of Technical Engine",
          "interpretation": "When price touches the upper envelope, it is considered overbought and a candidate for shorting. Touching the lower envelope suggests oversold conditions and a buying opportunity.",
          "interpretationVisual": [
                    {
                              "range": "Price at Lower Band",
                              "label": "Oversold",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Price in Middle",
                              "label": "Neutral",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Price at Upper Band",
                              "label": "Overbought",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "In strong trends, price can 'ride' the envelope. Use Envelopes strictly for mean-reversion in defined, horizontal trading ranges, not during breakouts.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Lines drawn parallel to a trend identifying support and resistance boundaries, creating a visual 'channel' for price action.",
          "calculation": "Draw a trendline connecting higher lows (support), and draw a parallel line connecting higher highs (resistance).",
          "weight": "2% of Technical Engine",
          "interpretation": "Buy near the lower channel line and sell near the upper channel line. A breakout or breakdown of the channel indicates a major acceleration or reversal of the trend.",
          "interpretationVisual": [
                    {
                              "range": "Breakdown Below Channel",
                    ...
                    {
                              "range": "Breakout Above Channel",
                              "label": "Acceleration",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Watch the midline of the Price Channel. If price consistently fails to reach the upper channel line and gets rejected at the midline, the uptrend is exhausting.",
          "dataSources": "Price Data",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Similar to Bollinger Bands but uses the Standard Error of a linear regression line rather than standard deviation, tracking trend direction more accurately.",
          "calculation": "Linear Regression Line +/- (Standard Error * Multiplier).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Tight bands indicate a strong, unambiguous trend. When the bands widen, trend clarity is being lost, signaling a potential reversal or consolidation phase.",
          "interpretationVisual": [
                    {
                              "range": "Price > Lower Band",
                              "label": "Oversold Extension",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Bands Expanding",
                              "label": "Volatility Increase",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Price > Upper Band",
                              "label": "Overbought Extension",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Because they are based on linear regression, use a break of the midline as an early warning that the statistical trend has fundamentally changed.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Volatility-based bands placed above and below an EMA, using the Average True Range (ATR) to adjust the band width dynamically.",
          "calculation": "Middle = 20-EMA; Upper = Middle + (2 * ATR); Lower = Middle - (2 * ATR).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "A close above the upper Keltner Channel signifies a strong breakout and a potential new uptrend. In sideways markets, use them for mean reversion trading.",
          "interpretationVisual": [
                    {
                              "range": "Close Below Lower Band",
                    ...
                    {
                              "range": "Close Above Upper Band",
                              "label": "Bullish Breakout",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Combine Keltner Channels with Bollinger Bands to detect the 'Squeeze'. When Bollinger Bands go entirely inside Keltner Channels, an explosive move is imminent.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "title": "Donchian Channels",
          "description": "Formed by taking the highest high and lowest low of the last N periods. It visually represents absolute price extremes and is famously used in turtle trading.",
          "calculation": "Upper = Highest High over N periods; Lower = Lowest Low over N periods; Middle = (Upper + Lower) / 2.",
          "weight": "3% of Technical Engine",
          "interpretation": "A classic breakout indicator. Entering long when price touches or breaks the Upper Donchian line indicates a new N-period high, signifying strong momentum.",
          "interpretationVisual": [
                    {
                              "range": "Hitting Lower Band",
                              "label": "New Lows",
                              "color": "text-red-500"
                    },
                    {
                    ...
                    {
                              "range": "Hitting Upper Band",
                              "label": "New Highs",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Use a 20-period Donchian Channel for entries and a 10-period Donchian Channel on the opposite side for trailing exits (The Turtle Strategy).",
          "dataSources": "High/Low Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "starc_bands",
          "title": "STARC Bands",
          "description": "Stoller Average Range Channel bands create boundaries using an SMA and adding/subtracting the ATR to anticipate likely price limits.",
          "calculation": "Upper = SMA + (Multiplier * ATR); Lower = SMA - (Multiplier * ATR).",
          "weight": "2% of Technical Engine",
          "interpretation": "Price moving into the STARC bands indicates extreme risk/reward zones. Over 90% of price action stays within the bands, making touches high-probability mean reversion areas.",
          "interpretationVisual": [
                    {
                              "range": "At Lower Band",
                              "label": "High Prob. Bounce",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "At SMA",
                    ...
                    {
                              "range": "At Upper Band",
                              "label": "High Prob. Rejection",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "STARC bands are superior to Bollinger Bands for finding tops/bottoms in low-volatility markets because ATR directly accounts for gap openings.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A momentum oscillator that double-smooths price changes to capture trend direction while filtering out market noise.",
          "calculation": "100 * (Double Smoothed Price Change / Double Smoothed Absolute Price Change).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Values above 0 indicate bullish momentum; values below 0 indicate bearish momentum. Look for TSI crosses over its signal line to trigger entries.",
          "interpretationVisual": [
                    {
                              "range": "TSI < 0 & Falling",
                              "label": "Bearish",
                    ...
                    {
                              "range": "TSI Crossing Signal",
                              "label": "Shift in Momentum",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "TSI > 0 & Rising",
          ...
          "proTip": "TSI is incredibly effective for spotting hidden divergences. If price makes a higher high but TSI barely crosses the zero line, a severe dump is looming.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Combines short, medium, and long-term price action into one oscillator to reduce the false divergences common in single-timeframe indicators.",
          "calculation": "Weighted sum of three distinct period averages of Buying Pressure divided by True Range.",
          "weight": "3% of Technical Engine",
          "interpretation": "A reading below 30 is oversold, while above 70 is overbought. The most powerful signals are bullish or bearish divergences combined with a break of the oscillator's moving average.",
          "interpretationVisual": [
                    {
                              "range": "< 30",
                              "label": "Oversold Buy Zone",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "30 - 70",
                              "label": "Neutral / Trending",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "> 70",
                              "label": "Overbought Sell Zone",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Wait for the Ultimate Oscillator to fall below 30, form a bullish divergence with price, and then cross above 50 before entering a long position.",
          "dataSources": "OHLC Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "trix",
          "title": "TRIX",
          "description": "A momentum oscillator that displays the percent rate of change of a triple exponentially smoothed moving average, effectively filtering out insignificant price movements.",
          "calculation": "1-period rate of change of an EMA(EMA(EMA(Price))).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Crosses above the zero line indicate an uptrend, while crosses below indicate a downtrend. It is largely immune to whipsaws making it ideal for swing trading.",
          "interpretationVisual": [
                    {
                              "range": "TRIX < 0",
                              "label": "Downtrend Intact",
                              "color": "text-red-500"
                    },
                    {
                              "range": "TRIX Near Zero",
                              "label": "Trend Change",
                              "color": "text-yellow-500"
                    },
                    {
          ...
          "proTip": "Ignore minor dips in the TRIX line. Only act on signals where the TRIX decisively crosses its 9-period signal line on a weekly timeframe for macro trades.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Measures pure momentum by calculating the difference between the sum of all recent gains and the sum of all recent losses, divided by total price movement.",
          "calculation": "100 * ((Sum of Up Days - Sum of Down Days) / (Sum of Up Days + Sum of Down Days)).",
          "weight": "2% of Technical Engine",
          "interpretation": "Values above +50 indicate extreme overbought conditions, while values below -50 indicate oversold conditions. Crossing the zero line signifies a shift in momentum.",
          "interpretationVisual": [
                    {
                              "range": "CMO < -50",
                              "label": "Oversold Extreme",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "-50 to +50",
                    ...
                    {
                              "range": "CMO > +50",
                              "label": "Overbought Extreme",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Overlay an SMA on the CMO line. When the CMO crosses above its SMA from a level below -50, it offers one of the highest-probability mean-reversion buy signals.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "coppock_curve",
          "title": "Coppock Curve",
          "description": "A smoothed momentum indicator originally designed to identify major, multi-year bottoms in stock market indices.",
          "calculation": "A 10-period WMA of the sum of the 14-period ROC and the 11-period ROC.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "The primary signal is a crossover from below zero to above zero on a monthly chart, indicating the start of a major macro bull run.",
          "interpretationVisual": [
                    {
                              "range": "Curve Below Zero",
                              "label": "Macro Bear Phase",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Curve Turning Up",
                              "label": "Accumulation Phase",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Curve Above Zero",
                              "label": "Macro Bull Phase",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "The Coppock Curve is exclusively for long-term investing. Do not use it on timeframes lower than the weekly chart, as it will generate meaningless laggy signals.",
          "dataSources": "Monthly/Weekly Close Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A complex momentum oscillator that blends four different rates of change (ROC) smoothed by moving averages, capturing momentum cycles at various timeframes.",
          "calculation": "Sum of four smoothed ROCs, weighted by their period lengths.",
          "weight": "2% of Technical Engine",
          "interpretation": "KST line crossing above its signal line indicates a buy, especially if both are below zero. Divergences between KST and price are highly reliable reversal patterns.",
          "interpretationVisual": [
                    {
                              "range": "KST < Signal",
                              "label": "Bear Cycle",
                    ...
                    {
                              "range": "KST Crossing Signal",
                              "label": "Cycle Reversal",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "KST > Signal",
          ...
          "proTip": "When the KST remains above zero for an extended period, it confirms a secular bull market. Use shorter-term oscillator dips to buy the prevailing KST trend.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          "id": "dpo_detrended_price_oscillator",
          "title": "Detrended Price Oscillator (DPO)",
          "description": "Removes the long-term trend from price to highlight short-term cycles, making it easier to identify tops and bottoms of the specific cycle length.",
          "calculation": "Price of N/2 + 1 periods ago minus an N-period SMA.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Peaks and troughs in the DPO correspond with peaks and troughs in the price cycle. Use it to estimate the timing of the next cycle peak or bottom.",
          "interpretationVisual": [
                    {
                              "range": "DPO making low",
                              "label": "Cycle Bottom",
                              "color": "text-emerald-500"
                    },
                    {
                    ...
                    {
                              "range": "DPO making high",
                              "label": "Cycle Top",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "DPO is displaced back in time. Use it historically to find the dominant cycle length of the asset, then apply that cycle length to forecast future turning points.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Combines MACD and Stochastic oscillators to create a smoother, faster, and more reliable momentum indicator designed to identify trends and cycles simultaneously.",
          "calculation": "Stochastic calculation applied to the MACD line, then smoothed using an EMA.",
          "weight": "3% of Technical Engine",
          "interpretation": "Generates buy signals when crossing above the 25 level and sell signals when crossing below the 75 level. It rarely whipsaws during strong trends.",
          "interpretationVisual": [
                    {
                              "range": "< 25",
                              "label": "Oversold Base",
                    ...
                    {
                              "range": "> 75",
                              "label": "Overbought Peak",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Unlike standard Stochastics, the STC will stay pinned at 100 or 0 during a strong trend. Do not fade a pinned STC; wait for the definitive cross back below 75 or above 25.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Measures the time it takes for price to reach the highest high or lowest low over a period, identifying whether a trend is intact or reversing.",
          "calculation": "Aroon Up = 100 * ((N - Days Since N-period High) / N); Aroon Down uses Lows.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "When Aroon Up crosses above Aroon Down, a new uptrend is emerging. If Aroon Up stays at 100, the trend is exceptionally strong.",
          "interpretationVisual": [
                    {
                              "range": "Aroon Down > 70",
                              "label": "Strong Downtrend",
                    ...
                    {
                              "range": "Lines Crossing",
                              "label": "Trend Transition",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Aroon Up > 70",
          ...
          "proTip": "If both Aroon lines move downward parallel to each other, the market is in heavy consolidation. Prepare for a massive breakout when one line spikes.",
          "dataSources": "High/Low Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Developed by Dr. Alexander Elder, it measures the power of bulls and bears relative to an EMA baseline using Bull Power and Bear Power histograms.",
          "calculation": "Bull Power = High - 13-EMA; Bear Power = Low - 13-EMA.",
          "weight": "2% of Technical Engine",
          "interpretation": "Go long when the EMA is rising and Bear Power is below zero but increasing. Go short when the EMA is falling and Bull Power is above zero but decreasing.",
          "interpretationVisual": [
                    {
                              "range": "Bear Power Deep Red",
                              "label": "Bears in Control",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Diverging Power",
                              "label": "Trend Weakening",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Bull Power High",
                              "label": "Bulls in Control",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "The most lucrative setup is 'Bear Power Divergence'—when price makes a new low but Bear Power makes a higher low, heavily signaling a bullish reversal.",
          "dataSources": "OHLC Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "force_index",
          "title": "Force Index",
          "description": "Combines price movement, its direction, and trading volume to measure the power behind market moves, confirming trend strength.",
          "calculation": "(Current Close - Previous Close) * Current Volume, smoothed with an EMA.",
          "weight": "3% of Technical Engine",
          "interpretation": "A rising Force Index confirms an uptrend. If price hits a new high but Force Index makes a lower high, the uptrend lacks volume support and will likely fail.",
          "interpretationVisual": [
                    {
                              "range": "Force Index < 0",
                              "label": "Selling Pressure",
                    ...
                    {
                              "range": "Force Index Near 0",
                              "label": "Lack of Conviction",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Force Index > 0",
          ...
          "proTip": "Use a 2-period EMA of the Force Index to pinpoint entries in an active trend. Buy when the 2-period Force Index goes negative in an overall uptrend.",
          "dataSources": "Price & Volume Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "ehlers_fisher_transform",
          "title": "Ehler's Fisher Transform",
          "description": "Applies a mathematical transformation to price data to create a nearly Gaussian probability distribution, turning turning points into sharp, distinct spikes.",
          "calculation": "0.5 * ln((1 + X) / (1 - X)) where X is normalized price within a range.",
          "weight": "3% of Technical Engine",
          "interpretation": "Identifies extreme price reversals with exceptional clarity. Crosses of the Fisher line over its signal line at extreme values are powerful buy/sell triggers.",
          "interpretationVisual": [
                    {
                              "range": "Fisher Turning Down at Peak",
                              "label": "Sharp Top Reversal",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Fisher Near Zero",
                              "label": "Normal Behavior",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Fisher Turning Up at Trough",
                              "label": "Sharp Bottom Reversal",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Because the Fisher Transform reacts instantly, use it to catch 'falling knives' or exact market tops, but always place a tight stop-loss below the pivot candle.",
          "dataSources": "High/Low Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "An refinement of the traditional Stochastic Oscillator that calculates the distance of the close relative to the midpoint of the high/low range.",
          "calculation": "100 * (Double Smoothed Distance from Midpoint / Double Smoothed Range).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Readings above +40 indicate overbought conditions, while below -40 indicate oversold. It produces fewer false signals than standard Stochastics.",
          "interpretationVisual": [
                    {
                              "range": "SMI < -40",
                              "label": "Deep Oversold",
          ...
          "proTip": "Look for zero-line rejections. If SMI drops from +40, hits the zero line, and bounces back up, it signals a massive continuation of the bullish trend.",
          "dataSources": "OHLC Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Comprises two oscillating lines (VI+ and VI-) representing positive and negative trend movement, based on the connection between highs and lows of consecutive periods.",
          "calculation": "True Range smoothed over N periods. VI+ based on Current High - Prior Low. VI- based on Current Low - Prior High.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A crossover of VI+ above VI- generates a buy signal, while VI- crossing above VI+ generates a sell signal. Wides gaps between the lines signify a relentless trend.",
          "interpretationVisual": [
                    {
                              "range": "VI- > VI+",
                              "label": "Bearish Control",
          ...
          "proTip": "The most robust signals occur when a Vortex crossover aligns tightly with a breakout from a recognized chart pattern (e.g., crossing bullish as a Bull Flag breaks).",
          "dataSources": "High/Low/Close Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Measures the momentum of the Accumulation/Distribution (A/D) line by subtracting a 10-day EMA of the A/D line from a 3-day EMA of the A/D line.",
          "calculation": "3-period EMA of A/D Line - 10-period EMA of A/D Line.",
          "weight": "2% of Technical Engine",
          "interpretation": "Anticipates directional changes in the A/D line. A positive Chaikin Oscillator indicates buying pressure, while negative indicates selling pressure.",
          "interpretationVisual": [
                    {
                              "range": "< 0",
          ...
          "proTip": "Divergence is key. If price hits a new high but the Chaikin Oscillator fails to break zero, heavy institutional distribution is happening under the surface.",
          "dataSources": "OHLCV Exchange Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Highlights changes in volume trends by calculating the difference between a short-term and long-term moving average of volume.",
          "calculation": "Fast Volume MA - Slow Volume MA, usually displayed as a percentage.",
          "weight": "2% of Technical Engine",
          "interpretation": "An expanding positive oscillator means volume is increasing, supporting the current price trend. A negative reading means volume is drying up.",
          "interpretationVisual": [
                    {
                              "range": "Negative",
                              "label": "Drying Liquidity",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Near Zero",
                    ...
                    {
                              "range": "Positive",
                              "label": "Increasing Liquidity",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Use the Volume Oscillator to confirm breakouts. A breakout with a sharply rising positive Volume Oscillator is highly likely to succeed.",
          "dataSources": "Volume Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Identifies momentum and trend direction exactly like the MACD, but expresses the difference between the two EMAs as a percentage, allowing comparison across assets.",
          "calculation": "((12-day EMA - 26-day EMA) / 26-day EMA) * 100.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A PPO above zero indicates the short-term average is above the long-term average (bullish). Signal line crossovers act as trade triggers.",
          "interpretationVisual": [
                    {
                              "range": "PPO < 0 & Falling",
          ...
          "proTip": "Because PPO is percentage-based, it is vastly superior to MACD for analyzing highly volatile assets (like crypto) over long timeframes where absolute price changes dramatically.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "mass_index",
          "title": "Mass Index",
          "description": "Predicts trend reversals by analyzing the expansion and contraction of the high-low range between periods.",
          "calculation": "Sum of (9-period EMA of (High-Low) / 9-period EMA of a 9-period EMA of (High-Low)) over 25 periods.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Looks for a 'Reversal Bulge'. If the Mass Index rises above 27 and then falls below 26.5, a trend reversal is highly probable.",
          "interpretationVisual": [
                    {
                              "range": "Index < 26.5",
                    ...
                    {
                              "range": "Index Drops Below 26.5",
                              "label": "Reversal Triggered",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "The Mass Index does not indicate direction. You must use an EMA (e.g., 9-day EMA) alongside the 'bulge' signal to determine whether the reversal is bullish or bearish.",
          "dataSources": "High/Low Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Determines whether the market is actively trending or simply moving sideways (choppy), independent of the trend's direction.",
          "calculation": "100 * LOG10(Sum(ATR(1), n) / (Max High(n) - Min Low(n))) / LOG10(n).",
          "weight": "3% of Technical Engine",
          "interpretation": "High values (above 61.8) indicate heavy consolidation and chop. Low values (below 38.2) indicate a strong directional trend.",
          "interpretationVisual": [
                    {
                              "range": "< 38.2",
                              "label": "Strong Trend Active",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "38.2 - 61.8",
                    ...
                    {
                              "range": "> 61.8",
                              "label": "Heavy Chop Zone",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Never deploy trend-following strategies when Choppiness > 61.8. Wait for the index to fall out of the chop zone to confirm a valid breakout.",
          "dataSources": "OHLC Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          "id": "dmi_directional_movement_index",
          "title": "Directional Movement Index (DMI)",
          "description": "Comprises +DI, -DI, and ADX to quantify both the direction of price movement and the absolute strength of the trend.",
          "calculation": "+DI (Positive Directional Indicator), -DI (Negative Directional Indicator), and the ADX (Average Directional Index).",
          "weight": "4% of Technical Engine",
          "interpretation": "When +DI is above -DI, the trend is up. When ADX rises above 25, it confirms the trend is strong enough to trade profitably.",
          "interpretationVisual": [
                    {
                              "range": "-DI > +DI & ADX > 25",
                              "label": "Strong Downtrend",
          ...
          "proTip": "A setup where ADX rises from below 20 while +DI crosses above -DI is widely considered one of the most reliable breakout signals in technical analysis.",
          "dataSources": "High/Low/Close Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A market breadth indicator tied to the stock exchange (e.g., NYSE) calculating the difference between advancing and declining issues to spot money flow.",
          "calculation": "19-day EMA of (Advances - Declines) minus 39-day EMA of (Advances - Declines).",
          "weight": "2% of Technical Engine",
          "interpretation": "Readings above zero indicate liquidity is flowing into the market. Extreme readings (+100 or -100) often signify overbought/oversold exhaustion points.",
          "interpretationVisual": [
                    {
                              "range": "< -100",
                              "label": "Oversold Breadth Extreme",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "-50 to +50",
                              "label": "Normal Breadth Flow",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "> +100",
                              "label": "Overbought Breadth Extreme",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "When the major index hits a new high but the McClellan Oscillator forms a lower high (below zero), a massive, system-wide correction is imminent.",
          "dataSources": "Market Breadth Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A short-term trading breadth tool that compares advancing and declining stock issues to advancing and declining volume.",
          "calculation": "(Advancing Issues / Declining Issues) / (Advancing Volume / Declining Volume).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A TRIN value below 1.0 is bullish (volume flowing into advancing stocks). A value above 1.0 is bearish. Values > 2.0 indicate capitulation selling.",
          "interpretationVisual": [
                    {
                              "range": "> 1.5",
                              "label": "Extreme Selling / Capitulation",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "0.8 - 1.2",
                    ...
                    {
                              "range": "< 0.5",
                              "label": "Extreme Greed / Top",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "In day trading, a TRIN spiking above 2.0 intraday usually marks the exact bottom of a panic selloff, offering a phenomenal counter-trend long entry.",
          "dataSources": "Market Breadth & Volume Data",
          "updateFrequency": "Intraday/Daily",
          "confidenceImpact": "High"
            },
{
          "id": "ad_line_advance_decline",
          "title": "Advance/Decline Line (A/D)",
          "description": "A cumulative line charting the daily difference between the number of advancing and declining issues, reflecting underlying market health.",
          "calculation": "Previous A/D Line + (Current Advancing Issues - Current Declining Issues).",
          "weight": "3% of Technical Engine",
          "interpretation": "Used to confirm the validity of an index trend. If the S&P 500 is rising but the A/D line is falling, the rally is narrow and likely to collapse.",
          "interpretationVisual": [
                    {
                              "range": "A/D Falling, Index Rising",
                              "label": "Bearish Divergence",
                              "color": "text-red-500"
                    },
                    {
                              "range": "A/D Rising, Index Rising",
          ...
          "proTip": "The A/D Line often tops out months before the actual stock market index peaks, making it an incredible leading indicator for cyclical bear markets.",
          "dataSources": "Market Breadth Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          "id": "tick_index",
          "title": "TICK Index",
          "description": "Measures the number of stocks making an uptick minus the number of stocks making a downtick at any given second, used heavily by day traders.",
          "calculation": "Stocks Upticking - Stocks Downticking.",
          "weight": "3% of Technical Engine",
          "interpretation": "Extremes gauge intraday buying or selling exhaustion. +1000 TICK indicates extreme buying (fade the rally), while -1000 TICK indicates extreme selling (buy the dip).",
          "interpretationVisual": [
                    {
                              "range": "< -1000",
                              "label": "Panic / Intraday Bottom",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "-400 to +400",
                              "label": "Normal Trading Range",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "> +1000",
                              "label": "Euphoria / Intraday Top",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Plot a 5-period EMA on the TICK index. Consistent closes above zero suggest institutions are accumulating silently throughout the day.",
          "dataSources": "Tick Data",
            ...
            },
{
          ...
          "description": "Tracks the percentage of stocks making new 52-week highs relative to the total number of stocks making either new 52-week highs or lows.",
          "calculation": "10-day SMA of (New Highs / (New Highs + New Lows)) * 100.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Readings below 30 indicate a severe downtrend, while readings above 70 indicate a strong uptrend. Extreme levels suggest trend exhaustion.",
          "interpretationVisual": [
                    {
                              "range": "< 20",
                              "label": "Market Washed Out",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "30 - 70",
                              "label": "Standard Trend",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "> 80",
                              "label": "Market Overextended",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "When the market crashes and the High-Low index drops below 10, start averaging into your long-term portfolio. These levels rarely occur outside of generational bottoms.",
          "dataSources": "52-Week High/Low Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Measures how many standard deviations the current price is away from its mean (SMA), identifying statistical outliers in price action.",
          "calculation": "(Price - N-period SMA) / N-period Standard Deviation.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A Z-score above 2.0 or below -2.0 signifies an abnormal price movement. Reversion to the mean is highly likely once these extremes are hit.",
          "interpretationVisual": [
                    {
                              "range": "< -2.0",
          ...
          "proTip": "Combine Z-Score with VWAP in intraday trading. Shorting an asset when it deviates 3 standard deviations from VWAP has an immensely high win rate.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A statistical measure of the dispersion of returns for a given security or market index over a specific period.",
          "calculation": "Annualized standard deviation of logarithmic daily price returns.",
          "weight": "2% of Technical Engine",
          "interpretation": "Low HV implies a market at rest, often preceding a massive explosive breakout. High HV implies a chaotic market prone to sharp reversals.",
          "interpretationVisual": [
                    {
                              "range": "Rising HV",
                              "label": "Expanding Risk/Reward",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Mean HV",
                              "label": "Average Market Pace",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Crashing HV",
          ...
          "proTip": "Options traders use HV. When HV is at historic lows, buy straddles/strangles; options are cheap, and an explosive directional move is guaranteed.",
          "dataSources": "Close Price Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Similar to RSI, but measures the direction of volatility instead of price momentum, providing an extra layer of confirmation.",
          "calculation": "Uses the standard deviation of prices over N periods instead of absolute price change in an RSI-style formula.",
          "weight": "2% of Technical Engine",
          "interpretation": "RVI > 50 indicates that volatility is skewed to the upside. RVI < 50 indicates volatility is skewed to the downside.",
          "interpretationVisual": [
                    {
                              "range": "< 40",
                              "label": "Bearish Volatility",
                              "color": "text-red-500"
                    },
                    {
                              "range": "40 - 60",
                    ...
                    {
                              "range": "> 60",
                              "label": "Bullish Volatility",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Use RVI purely as a filter for other systems. Do not take a long moving average crossover unless RVI > 50 confirms upside volatility.",
          "dataSources": "Standard Deviation Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          "id": "ulcer_index",
          "title": "Ulcer Index",
          "description": "Measures the depth and duration of price declines (drawdowns) from recent highs to quantify downside risk and market stress.",
          "calculation": "Square root of the average of squared percentage drawdowns over N periods.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "A rising Ulcer Index indicates increasing risk and deeper drawdowns. A falling index shows price is recovering or pushing into new highs smoothly.",
          "interpretationVisual": [
                    {
                              "range": "Spiking Index",
                    ...
                    {
                              "range": "Elevated but Flat",
                              "label": "Grinding Bear Phase",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Near Zero",
                              "label": "Smooth Bull Phase",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Evaluate a trading system's equity curve using the Ulcer Index instead of max drawdown. It punishes systems that stay underwater for long periods.",
          "dataSources": "High/Close Price Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          "id": "beta",
          "title": "Beta",
          "description": "Measures the volatility, or systemic risk, of an individual stock in comparison to the unsystematic risk of the entire market.",
          "calculation": "Covariance of Asset's Return with Market's Return / Variance of Market's Return.",
          "weight": "2% of Technical Engine",
          "interpretation": "Beta > 1 means the asset is more volatile than the broader market. Beta < 1 means it is less volatile. Beta = 1 matches the market.",
          "interpretationVisual": [
                    {
                              "range": "< 0.8",
                    ...
                    {
                              "range": "> 1.5",
                              "label": "Aggressive/Volatile",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "In a confirmed bull market, heavily overweight high Beta (1.5+) tech stocks to outpace the index. In a bear market, shift to low Beta defensive utilities.",
          "dataSources": "Asset & Market Benchmark Data",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A classic bearish reversal chart pattern featuring three peaks, with the middle peak (head) being the highest and the outer two (shoulders) being lower and roughly equal.",
          "calculation": "Identification of Left Shoulder, Head, Right Shoulder, and a connecting Neckline support.",
          "weight": "4% of Technical Engine",
          "interpretation": "A close below the 'neckline' confirms the pattern and triggers a short sell. The price target is the distance from the head to the neckline, subtracted from the breakdown point.",
          "interpretationVisual": [
                    {
                              "range": "Forming Right Shoulder",
                              "label": "Warning",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Neckline Break",
                              "label": "Confirmed Short",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "The most reliable Head and Shoulders patterns feature declining volume on the right shoulder, proving buyers have completely exhausted their capital.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "Absolute"
            },
{
          "id": "inverse_head_and_shoulders",
          "title": "Inverse Head and Shoulders",
          "description": "A major bullish reversal pattern occurring at the end of a downtrend, featuring three valleys, with the middle valley being the deepest.",
          "calculation": "Identification of Left Shoulder, Head, Right Shoulder troughs, and a connecting Neckline resistance.",
          "weight": "4% of Technical Engine",
          "interpretation": "A breakout above the neckline, especially on high volume, confirms the reversal. Price target equals the depth of the head projected upward from the breakout.",
          "interpretationVisual": [
                    {
                              "range": "Right Shoulder Forming",
                              "label": "Accumulation",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Neckline Breakout",
                              "label": "Confirmed Long",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Target Missed",
          ...
          "proTip": "If the right shoulder is higher than the left shoulder, the bullish setup is significantly stronger due to early institutional front-running.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "Absolute"
            },
{
          "id": "double_top",
          "title": "Double Top",
          "description": "A bearish technical reversal pattern that forms after an asset reaches a high price two consecutive times with a moderate decline between the two highs.",
          "calculation": "Two distinct peaks at roughly the same price level, separated by a trough (support line).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "The pattern is confirmed when the price breaks below the support level (the valley low between the peaks). Target is the height of the formation subtracted from support.",
          "interpretationVisual": [
                    {
                              "range": "Hitting 2nd Top",
                              "label": "Resistance Test",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breaking Valley Support",
          ...
          "proTip": "Look for bearish divergence on the RSI at the second peak. If the price makes an equal high but the RSI makes a significantly lower high, short heavily.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          "id": "double_bottom",
          "title": "Double Bottom",
          "description": "A bullish technical reversal pattern that looks like the letter 'W', describing a drop, a rebound, another drop to the same level, and a final rebound.",
          "calculation": "Two distinct troughs at roughly the same price level, separated by a peak (resistance line).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Confirmation occurs when the price breaks out above the central peak's resistance level. It indicates a massive transfer of control from sellers to buyers.",
          "interpretationVisual": [
                    {
                              "range": "Hitting 2nd Bottom",
                              "label": "Support Test",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breaking Peak Resistance",
          ...
          "proTip": "The most explosive double bottoms occur when the second bottom briefly 'sweeps' below the first bottom's low to hunt stop-losses before rocketing higher.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          "id": "triple_top",
          "title": "Triple Top",
          "description": "An extended bearish reversal pattern consisting of three equal peaks, showing buyers have repeatedly failed to push price higher.",
          "calculation": "Three peaks at the same resistance level with two intervening troughs that form a support line.",
          "weight": "3% of Technical Engine",
          "interpretation": "A decisive break below the support line established by the troughs signals the onset of a major downtrend. The longer the timeframe, the harder the crash.",
          "interpretationVisual": [
                    {
                              "range": "At 3rd Peak",
                              "label": "Triple Resistance",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breaking Support",
                              "label": "Trend Collapse",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Target Reached",
                              "label": "Bottom Seeking",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "By the third peak, volume should be noticeably lower than on the first peak. If volume is expanding on the third peak, do not short; a breakout is likely.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          "id": "triple_bottom",
          "title": "Triple Bottom",
          "description": "A powerful bullish reversal pattern where price bounces off the same support level three times, proving an absolute floor has been established.",
          "calculation": "Three troughs at the same support level with two intervening peaks that form a resistance line.",
          "weight": "3% of Technical Engine",
          "interpretation": "Breaking the resistance line connecting the intervening peaks triggers a massive buy signal. Sellers are trapped, causing a short-squeeze up.",
          "interpretationVisual": [
                    {
                              "range": "At 3rd Bottom",
                              "label": "Triple Support",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breaking Resistance",
                              "label": "Trend Liftoff",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Target Reached",
                              "label": "Uptrend Established",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Wait for the breakout to close above resistance. A triple bottom can often morph into a descending triangle if the intervening peaks are making lower highs.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          "id": "rising_wedge",
          "title": "Rising Wedge",
          "description": "A bearish chart pattern that begins wide at the bottom and contracts as prices move higher, indicating an uptrend losing momentum.",
          "calculation": "Connecting higher highs with a trendline and higher lows with a steeper trendline, forming a contracting wedge.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Although making higher highs, the contracting range indicates buyer exhaustion. A breakdown below the lower support line strongly signals a bearish reversal.",
          "interpretationVisual": [
                    {
                              "range": "Inside Wedge",
                              "label": "Momentum Dying",
                              "color": "text-yellow-500"
                    },
                    {
          ...
          "proTip": "Rising wedges that form after a long, vertical runup (a blow-off top) have the highest probability of resulting in a violent crash.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "falling_wedge",
          "title": "Falling Wedge",
          "description": "A bullish pattern that begins wide at the top and contracts as prices move lower, signaling that downside momentum is decelerating.",
          "calculation": "Connecting lower highs with a trendline and lower lows with a shallower trendline, forming a contracting wedge.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "A breakout above the upper resistance line is a strong buy signal, indicating buyers have overwhelmed the dwindling selling pressure.",
          "interpretationVisual": [
                    {
                              "range": "Inside Wedge",
                              "label": "Sellers Exhausting",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Resistance Breakout",
                              "label": "Long Trigger",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Falling wedges are notorious for false breakdowns (bear traps) just before they break upward. Never short a falling wedge.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "bull_flag",
          "title": "Bull Flag",
          "description": "A short-term continuation pattern resembling a flag on a pole. The 'pole' is a sharp vertical price spike, followed by a downward-sloping rectangular channel (the flag).",
          "calculation": "Identify the pole (impulse wave), followed by two parallel downward-sloping trendlines containing the consolidation.",
          "weight": "4% of Technical Engine",
          "interpretation": "Represents a brief pause before the next explosive move higher. Buy upon a breakout above the upper resistance line of the flag.",
          "interpretationVisual": [
                    {
                              "range": "Consolidating in Flag",
                              "label": "Resting Phase",
                              "color": "text-yellow-500"
                    },
                    {
          ...
          "proTip": "The flag consolidation must be on noticeably declining volume. If volume stays high during the flag formation, it is likely a distribution top, not a continuation.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "bear_flag",
          "title": "Bear Flag",
          "description": "A bearish continuation pattern characterized by a sharp downward price drop (the pole) followed by an upward-sloping rectangular consolidation channel.",
          "calculation": "Identify the pole (bearish impulse), followed by two parallel upward-sloping trendlines containing the bounce.",
          "weight": "4% of Technical Engine",
          "interpretation": "Signals a dead-cat bounce before another severe leg down. Short the asset when it breaks below the lower support line of the flag.",
          "interpretationVisual": [
                    {
                              "range": "Bouncing in Flag",
          ...
          "proTip": "Measure the length of the initial drop (pole) and project it downward from the breakdown point to get an incredibly accurate profit target.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "bull_pennant",
          "title": "Bull Pennant",
          "description": "Similar to a bull flag, but the consolidation phase is a small symmetrical triangle rather than a parallel channel.",
          "calculation": "Identify the pole, followed by converging trendlines (lower highs, higher lows) forming a small triangle.",
          "weight": "3% of Technical Engine",
          "interpretation": "A pause in an uptrend that resolves with a violent continuation upward. A breakout through the upper converging line triggers the buy.",
          "interpretationVisual": [
                    {
                              "range": "Inside Pennant",
                              "label": "Coiling Up",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breakout",
                              "label": "Explosive Move Up",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Breakdown",
          ...
          "proTip": "Pennants are extremely short-term patterns (often lasting just 1-3 weeks on daily charts). If it takes too long to resolve, it morphs into a standard symmetrical triangle.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          "id": "bear_pennant",
          "title": "Bear Pennant",
          "description": "A bearish continuation pattern where a sharp drop is followed by a small consolidating symmetrical triangle.",
          "calculation": "Identify the pole downward, followed by converging trendlines forming a small pennant.",
          "weight": "3% of Technical Engine",
          "interpretation": "Sellers are taking a brief breath. A break below the lower trendline indicates the selloff has resumed.",
          "interpretationVisual": [
                    {
                              "range": "Inside Pennant",
                              "label": "Bearish Coil",
          ...
          "proTip": "A true bear pennant will form right at or just below a major moving average (like the 20 EMA) acting as dynamic resistance.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A bullish continuation pattern characterized by a flat upper resistance line and a rising lower support line.",
          "calculation": "Horizontal resistance line connecting swing highs, and an ascending trendline connecting higher swing lows.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Buyers are aggressively stepping in at higher and higher prices, while sellers are absorbing supply at a fixed price. A breakout above resistance is highly likely.",
          "interpretationVisual": [
                    {
                              "range": "Price Squeezing",
                              "label": "Pressure Building",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Resistance Break",
                              "label": "Bullish Breakout",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Buy the retest. After the price breaks above the flat resistance line, it almost always drops back down to test that line as new support before launching higher.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A bearish continuation pattern characterized by a descending upper resistance line and a flat lower support line.",
          "calculation": "Descending trendline connecting lower swing highs, and a horizontal support line connecting swing lows.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Sellers are aggressively pushing price down at lower and lower levels, while buyers defend a fixed floor. Eventually, the floor breaks, leading to a flush.",
          "interpretationVisual": [
                    {
                              "range": "Price Squeezing",
                              "label": "Sellers Pressing",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Support Break",
                    ...
                    {
                              "range": "Resistance Break",
                              "label": "Bullish Failure",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "In massive bull markets, descending triangles often fail and break upward violently, trapping late shorts. Always wait for the daily close below support to enter short.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A neutral pattern formed by two converging trendlines, indicating a period of consolidation before price breaks out strongly in either direction.",
          "calculation": "Connecting lower highs with a descending trendline and higher lows with an ascending trendline.",
          "weight": "3% of Technical Engine",
          "interpretation": "A breakout can happen in either direction. Traders should place entry orders above the upper trendline and below the lower trendline to catch the eventual move.",
          "interpretationVisual": [
                    {
                              "range": "Price Coiling",
                              "label": "Indecision",
                    ...
                    {
                              "range": "Downside Break",
                              "label": "Bear Drop",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Symmetrical triangles resolve best halfway to two-thirds of the way to the apex. If price wanders all the way into the exact apex, the breakout will be weak and choppy.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A pattern where price moves between parallel support and resistance lines, forming a horizontal channel.",
          "calculation": "Horizontal resistance connecting highs, horizontal support connecting lows.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Represents a battle between supply and demand. Trade the range (buy support, sell resistance) until a definitive breakout occurs on high volume.",
          "interpretationVisual": [
                    {
                              "range": "At Support",
                              "label": "Range Buy",
                    ...
                    {
                              "range": "Breakout of Range",
                              "label": "Trend Start",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "The longer a market stays in a rectangle consolidation, the more explosive the eventual breakout will be ('The bigger the base, the higher in space').",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A powerful bullish continuation pattern resembling a teacup, consisting of a rounded bottom (the cup) followed by a slight downward drift (the handle).",
          "calculation": "A 'U' shaped price curve followed by a brief, small retracement or descending channel that forms the handle.",
          "weight": "4% of Technical Engine",
          "interpretation": "The handle represents the final shakeout of weak hands. A breakout above the rim of the cup triggers a massive buy signal.",
          "interpretationVisual": [
                    {
                              "range": "Forming Cup",
                              "label": "Accumulation",
                    ...
                    {
                              "range": "Forming Handle",
                              "label": "Final Shakeout",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breakout Above Rim",
                              "label": "Liftoff",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "A perfect handle retraces exactly 38.2% of the cup's depth. If the handle drops more than 50%, the pattern is invalid and likely to fail.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A long-term reversal pattern indicating a gradual shift from a bearish trend to a bullish one, visually forming a 'saucer' shape.",
          "calculation": "A prolonged, smooth 'U' shaped recovery in price action spanning months or years.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Patience is required. The pattern is confirmed when the price breaks above the 'neckline' formed prior to the start of the decline.",
          "interpretationVisual": [
                    {
                              "range": "Left Side Drop",
                              "label": "Bear Phase",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Bottom Basin",
                              "label": "Slow Accumulation",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Right Side Rise",
                              "label": "Bull Transition",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Volume must perfectly mirror the price action: high during the initial drop, drying up at the flat bottom, and massively expanding on the right side upswing.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A pattern identifying speculative tops where price advances at a sustainable trend, abruptly accelerates into a steep 'bump', and then crashes.",
          "calculation": "Lead-in trendline (30-45 degrees), followed by a bump phase trendline (45-60+ degrees).",
          "weight": "3% of Technical Engine",
          "interpretation": "When price breaks below the hyper-steep 'bump' trendline, it is an early warning. When it breaks below the original lead-in trendline, the crash is confirmed.",
          "interpretationVisual": [
                    {
                              "range": "Lead-in Phase",
                              "label": "Healthy Trend",
                    ...
                    {
                              "range": "Bump Phase",
                              "label": "Speculative Mania",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Run Phase (Crash)",
                              "label": "Bubble Popped",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "This is the premier pattern for shorting crypto blow-off tops. Once the parabolic curve breaks, do not attempt to buy the dip.",
          "dataSources": "Chart Pattern Recognition",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "measured_move",
          "title": "Measured Move",
          "description": "A multi-part trend pattern consisting of an impulse leg, a corrective phase, and a secondary impulse leg that equals the distance of the first.",
          "calculation": "Length of First Impulse Wave = Projected Length of Second Impulse Wave starting from the correction low.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Allows traders to pinpoint exact profit-taking levels by measuring prior price swings and projecting them forward in a trending market.",
          "interpretationVisual": [
                    {
                              "range": "First Leg Up",
                              "label": "Initial Impulse",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Correction",
                    ...
                    {
                              "range": "Target Achieved",
                              "label": "Measured Move Complete",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Measured moves work perfectly with Elliott Wave theory, acting as the mathematical basis for 'Wave 5 equals Wave 1' targets.",
          "dataSources": "Swing High/Low Data",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A classic harmonic pattern utilizing specific Fibonacci retracements to identify high-probability reversal zones at the 'D' point.",
          "calculation": "XA impulse, AB retraces 61.8% of XA, BC retraces 38.2-88.6% of AB, CD projects 127.2-161.8% of BC, finishing at 78.6% retracement of XA.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Buy/Sell precisely at the 'D' point completion (78.6% of XA). Harmonics rely on the mathematical confluence of Fibonacci zones.",
          "interpretationVisual": [
                    {
                              "range": "Forming C Leg",
                              "label": "Pattern Developing",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Approaching D",
                    ...
                    {
                              "range": "Hitting D Point",
                              "label": "Execute Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "The most important rule of the Gartley is that point B MUST be an exact 61.8% retracement. If it misses, it is a completely different harmonic pattern.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          "id": "bat_pattern",
          "title": "Bat Pattern",
          "description": "A harmonic pattern discovered by Scott Carney, similar to the Gartley but utilizing a deeper 88.6% Fibonacci retracement for the 'D' point completion.",
          "calculation": "XA impulse, AB retraces 38.2-50% of XA, BC retraces 38.2-88.6% of AB, CD finishes precisely at 88.6% retracement of XA.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Provides incredibly accurate reversals because 88.6% is a deep, psychological extreme where retail traders panic sell the exact bottom.",
          "interpretationVisual": [
                    {
                              "range": "Forming C Leg",
                              "label": "Pattern Developing",
                    ...
                    {
                              "range": "Hitting D Point (88.6%)",
                              "label": "Execute Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Because the entry is so deep (88.6%), you can place an incredibly tight stop-loss just past the original X point, offering a monstrous Risk/Reward ratio.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "An extension harmonic pattern where the 'D' point completes beyond the original 'X' point, signaling an exhaustion reversal at new highs/lows.",
          "calculation": "XA impulse, AB retraces 78.6% of XA. Point D extends to the 127.2% Fibonacci extension of the XA leg.",
          "weight": "3% of Technical Engine",
          "interpretation": "Identifies false breakouts. Retail buys the breakout above X, while smart money uses the 127.2% extension (Point D) to aggressively fade the move.",
          "interpretationVisual": [
                    {
                              "range": "Breaking X Point",
                              "label": "False Breakout Alert",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Approaching D",
                              "label": "Prepare to Fade",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Hitting D Point (127.2%)",
                              "label": "Execute Fade Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Ensure the BC leg is a tight 38.2-88.6% retracement. If the internal structure is sloppy, the 127.2% extension will fail to hold.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          "id": "crab_pattern",
          "title": "Crab Pattern",
          "description": "Considered the most precise harmonic pattern, utilizing a massive 161.8% Fibonacci extension of the XA leg for its reversal zone.",
          "calculation": "AB retraces 38.2-61.8% of XA. The defining feature is the CD leg extending to a massive 161.8% of the XA leg.",
          "weight": "3% of Technical Engine",
          "interpretation": "Captures violent, capitulation extremes. Price will often spike into the 161.8% level rapidly before sharply reversing the other way.",
          "interpretationVisual": [
                    {
                              "range": "Rapid Extension",
                              "label": "Capitulation Phase",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Approaching D",
                    ...
                    {
                              "range": "Hitting D Point (161.8%)",
                              "label": "Execute Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Place limit orders exactly at the 161.8% level. Do not wait for candle confirmation, as the reversal from a Crab pattern is usually a rapid, single-bar 'V-bottom'.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A variation of the Crab pattern where the initial 'B' point retraces much deeper to the 88.6% level before rocketing to the 161.8% extension.",
          "calculation": "AB retraces exactly 88.6% of XA. CD still extends to the 161.8% level of the XA leg.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Highly effective for capturing exhaustion tops/bottoms in assets that are ranging heavily before suddenly breaking out.",
          "interpretationVisual": [
                    {
                              "range": "Deep B Point",
                              "label": "Range Bound",
                    ...
                    {
                              "range": "Sudden Extension",
                              "label": "Breakout Manipulation",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Hitting D Point",
          ...
          "proTip": "The Deep Crab's B point at 88.6% often creates an initial Double Bottom/Top. When that pattern breaks and extends, the Crab catches the ultimate trap.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A 5-point harmonic pattern with distinct rules: the C point breaks beyond the A point, creating an expanding structure before reversing at D.",
          "calculation": "B retraces 38.2-61.8% of XA. C extends to 127.2-141.4% of XA. D retraces 78.6% of the XC leg.",
          "weight": "2% of Technical Engine",
          "interpretation": "An advanced pattern that capitalizes on a 'stop-hunt'. The C point takes out the high/low of A, trapping traders before reversing to D.",
          "interpretationVisual": [
                    {
                              "range": "C taking out A",
                              "label": "Stop Hunt Active",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Reversing to D",
                              "label": "Trap Sprung",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Hitting D (78.6%)",
                              "label": "Execute Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Cypher patterns have a lower hit rate but massive R:R. Target the A point for your first take-profit once you enter at D.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Moderate"
            },
{
          "id": "shark_pattern",
          "title": "Shark Pattern",
          "description": "An aggressive new harmonic structure that initiates a sequence, often leading into a 5-0 pattern. Features an extreme C point extension.",
          "calculation": "B point has no specific ratio. C extends to 113%-161.8% of AB. D extends to 88.6%-113% of the 0X leg.",
          "weight": "2% of Technical Engine",
          "interpretation": "Best traded as an impulse leg. When D hits 88.6% to 113% of the starting 0X wave, expect a violent, rapid reversal.",
          "interpretationVisual": [
                    {
                              "range": "Extreme C Leg",
                              "label": "Volatile Move",
          ...
          "proTip": "Trade the Shark pattern on lower timeframes (15m, 1h) as it perfectly models the 'pump and dump' algorithmic cycles of modern markets.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Moderate"
            },
{
          "id": "5_0_pattern",
          "title": "5-0 Pattern",
          "description": "A highly precise structure consisting of 5 points (0, X, A, B, C, D) that relies heavily on a 50% retracement of a specific projected leg.",
          "calculation": "Starts with a Shark. The D point is exactly a 50% retracement of the AB leg.",
          "weight": "2% of Technical Engine",
          "interpretation": "A pure trend-continuation harmonic pattern. The 50% retracement at point D aligns with major moving averages or volume nodes.",
          "interpretationVisual": [
                    {
                              "range": "Forming C Leg",
                              "label": "Trend established",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Pullback to 50%",
                              "label": "Healthy Correction",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Hitting 50% D Point",
                              "label": "Execute Continuation",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Ensure the C point hit a 161.8% to 224% extension. The severity of the C leg guarantees that the 50% pullback to D will be heavily defended.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "High"
            },
{
          "id": "abcd_pattern",
          "title": "AB=CD Pattern",
          "description": "The foundation of all harmonic patterns, representing a perfectly symmetrical, measured zigzag movement in price action.",
          "calculation": "Leg AB = Leg CD in price and time length. C retraces 61.8% or 78.6% of AB. D extends to 127.2% or 161.8% of BC.",
          "weight": "3% of Technical Engine",
          "interpretation": "When the CD leg equals the AB leg, algorithmic trading bots lock in profits, causing an immediate reversal at point D.",
          "interpretationVisual": [
                    {
                              "range": "Forming AB Leg",
                              "label": "Initial Impulse",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Forming CD Leg",
                              "label": "Symmetry Matching",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "AB = CD Completion",
                              "label": "Execute Reversal",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Symmetry in TIME is just as important as PRICE. If AB took 10 candles, CD should also take roughly 10 candles. If CD is too fast, the pattern is void.",
          "dataSources": "Swing High/Low Data",
          "updateFrequency": "Real-time Update",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A rare but powerful reversal pattern consisting of three consecutive symmetrical price drives forming higher highs or lower lows.",
          "calculation": "Drive 2 is a 127.2% or 161.8% extension of Drive 1. Drive 3 is a 127.2% or 161.8% extension of Drive 2. Symmetrical pullbacks between each.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "By the third drive, market participants are utterly exhausted. Enter your reversal trade precisely as the third drive hits its Fibonacci extension target.",
          "interpretationVisual": [
                    {
                              "range": "Drive 1 & 2",
                              "label": "Trend Maturing",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Drive 3 Extension",
                              "label": "Exhaustion Phase",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Reversal at Peak",
                              "label": "Execute Fade Trade",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Correlate this with an oscillator (RSI/MACD). You must see a 'three-wave divergence' on the oscillator perfectly matching the three drives in price.",
          "dataSources": "Fibonacci Calculations",
          "updateFrequency": "Pattern Completion",
          "confidenceImpact": "High"
            },
{
          "id": "doji_standard",
          "title": "Doji (Standard)",
          "description": "A candlestick where the open and close are virtually identical, forming a cross shape, symbolizing total indecision between buyers and sellers.",
          "calculation": "Open price equals (or nearly equals) Close price, with noticeable upper and lower wicks.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "A warning sign. If a Doji appears after an extended uptrend or downtrend, it signals that the prevailing trend is losing momentum and may reverse.",
          "interpretationVisual": [
                    {
                              "range": "In Uptrend",
                              "label": "Top Warning",
                    ...
                    {
                              "range": "In Consolidation",
                              "label": "Neutral Noise",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "In Downtrend",
                              "label": "Bottom Warning",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "A single Doji means nothing. Wait for the next candle to close. If it closes in the opposite direction of the prior trend, the reversal is confirmed.",
          "dataSources": "Candlestick Open/Close Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A bearish candlestick with a long upper wick and the open, close, and low all at the same level at the very bottom of the candle.",
          "calculation": "Open = Close = Low. Upper wick length > 3x the body (if any).",
          "weight": "2% of Technical Engine",
          "interpretation": "Found at the top of an uptrend. It shows buyers pushed the price massively higher, but sellers completely overwhelmed them by the close.",
          "interpretationVisual": [
                    {
                              "range": "Formation",
                              "label": "Intraday Rejection",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Next Candle Lower",
                              "label": "Confirmed Sell",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Next Candle Higher",
                              "label": "Invalidated",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "The longer the upper wick, the more significant the resistance level established. Place your stop-loss exactly 1 tick above the top of the wick.",
          "dataSources": "Candlestick OHLC Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A bullish candlestick with a long lower wick and the open, close, and high all at the same level at the very top of the candle.",
          "calculation": "Open = Close = High. Lower wick length > 3x the body (if any).",
          "weight": "2% of Technical Engine",
          "interpretation": "Found at the bottom of a downtrend. It shows sellers pushed the price heavily down, but aggressive buyers stepped in and drove it back to the open.",
          "interpretationVisual": [
                    {
                              "range": "Formation",
                              "label": "Intraday Absorption",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Next Candle Higher",
          ...
          "proTip": "A Dragonfly Doji touching a major moving average (like the 200 SMA) is one of the highest-probability bounce trades in technical analysis.",
          "dataSources": "Candlestick OHLC Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A candlestick with extremely long upper and lower wicks, and the open and close pinned exactly in the middle of the price range.",
          "calculation": "Open = Close. Upper Wick = Lower Wick. Total length of the candle is significantly larger than average ATR.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Represents massive volatility and ultimate indecision. A vicious tug-of-war occurred, but neither side won. A violent breakout is impending.",
          "interpretationVisual": [
                    {
                    ...
                    {
                              "range": "Break Above Wick High",
                              "label": "Bulls Win Setup",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Break Below Wick Low",
                              "label": "Bears Win Setup",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Do not trade during the Long-Legged Doji. Draw horizontal lines at its absolute high and low, and trade the subsequent breakout of that range.",
          "dataSources": "Candlestick OHLC Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Moderate"
            },
{
          "id": "hammer",
          "title": "Hammer",
          "description": "A bullish candlestick pattern featuring a small real body at the upper end of the trading range and a long lower wick, resembling a hammer.",
          "calculation": "Lower Wick > 2x Real Body length. Little to no upper wick. Appears after a decline.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Signals capitulation by sellers and aggressive buying. The market hammered out a bottom. A strong long entry if the next candle is green.",
          "interpretationVisual": [
                    {
                              "range": "In Uptrend",
                    ...
                    {
                              "range": "Confirmed Reversal",
                              "label": "Liftoff",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "A Hammer is twice as reliable if it closes green (Close > Open) rather than red, showing buyers not only defended the low but actually gained ground by the close.",
          "dataSources": "Candlestick OHLC Data",
          "updateFrequency": "Per candle",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A bullish reversal candlestick pattern found at the bottom of a downtrend, characterized by a long upper shadow and a small real body near the low.",
          "calculation": "Upper Shadow >= 2 * Real Body AND Lower Shadow <= 5% of Total Range AND Open, Close are in the lower third of the range.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Look for a gap up or a bullish white candle the next day to confirm the reversal before going long.",
          "interpretationVisual": [
                    {
                              "range": "Unconfirmed",
                              "label": "Wait",
          ...
          "proTip": "The longer the upper shadow, the higher the potential for a reversal, but wait for next-day volume confirmation.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "hanging_man",
          "title": "Hanging Man",
          "description": "A bearish reversal candlestick pattern occurring at the top of an uptrend, defined by a small body and a long lower shadow.",
          "calculation": "Lower Shadow >= 2 * Real Body AND Upper Shadow <= 5% of Total Range AND Open, Close are in the upper third.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Signals a potential top. Wait for the next candle to close below the Hanging Man's body to confirm the bearish reversal.",
          "interpretationVisual": [
                    {
                              "range": "Unconfirmed",
                              "label": "Caution",
          ...
          "proTip": "A hanging man with high volume is more reliable. Always confirm with a bearish close on the following period.",
          "dataSources": "Price Action OHLC, Volume",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "shooting_star",
          "title": "Shooting Star",
          "description": "A bearish reversal candlestick that forms during an uptrend, featuring a small real body near the session's low and a long upper shadow.",
          "calculation": "Upper Shadow >= 2 * Real Body AND Lower Shadow <= 5% of Total Range AND gap up from previous close.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Indicates buyers pushed prices up but sellers rejected them aggressively. Suggests selling pressure is building.",
          "interpretationVisual": [
                    {
                              "range": "No Gap",
                              "label": "Weak Signal",
                    ...
                    {
                              "range": "Reclaimed High",
                              "label": "Invalidated",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Look for shooting stars near major resistance levels or upper Bollinger Bands for higher probability setups.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          "id": "spinning_top",
          "title": "Spinning Top",
          "description": "A candlestick pattern with a short real body and relatively equal upper and lower shadows, representing indecision.",
          "calculation": "Real Body < 30% of Total Range AND Upper Shadow ≈ Lower Shadow.",
          "weight": "1.0% of Technical Engine",
          "interpretation": "Represents a tug-of-war between buyers and sellers. Often signals a pause or upcoming consolidation rather than an immediate reversal.",
          "interpretationVisual": [
                    {
                              "range": "Sideways",
                              "label": "Indecision",
          ...
          "proTip": "A spinning top after a strong trend can foreshadow a reversal if followed by an opposite-colored strong candle.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A strong bullish candlestick with no shadows, indicating buyers controlled the price from the open to the close.",
          "calculation": "Open == Low AND Close == High AND Close > Open (Tolerance < 0.1% for shadows).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Extremely bullish sign. In an uptrend, it implies continuation; in a downtrend, a potential strong reversal.",
          "interpretationVisual": [
                    {
                              "range": "Downtrend Reversal",
                              "label": "Strong Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Uptrend Continuation",
                              "label": "Hold/Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Loss of Momentum",
                              "label": "Caution",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "A Marubozu breaking out of a resistance level or chart pattern is a highly reliable entry signal.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A strong bearish candlestick completely lacking shadows, showing sellers dominated the entire session.",
          "calculation": "Open == High AND Close == Low AND Close < Open (Tolerance < 0.1% for shadows).",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Extremely bearish. Indicates aggressive selling and likelihood of continued downward momentum.",
          "interpretationVisual": [
                    {
                              "range": "Uptrend Reversal",
                              "label": "Strong Sell",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Downtrend Continuation",
                              "label": "Hold Short",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "Combine a bearish Marubozu with high volume slicing through key moving averages for maximum conviction.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A single candlestick pattern with a small body and a very long lower shadow, acting as a precursor to Hammers or Hanging Men.",
          "calculation": "Lower Shadow >= 2 * Real Body AND Upper Shadow ≈ 0.",
          "weight": "1.0% of Technical Engine",
          "interpretation": "Context dictates meaning. A paper umbrella in a downtrend (Hammer) is bullish, while in an uptrend (Hanging Man) is bearish.",
          "interpretationVisual": [
                    {
                              "range": "Downtrend",
                              "label": "Potential Bullish",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Uptrend",
                              "label": "Potential Bearish",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Consolidation",
          ...
          "proTip": "Look for the shadow length to be at least three times the body for higher reliability.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A candle with long upper and lower shadows and a small real body, reflecting extreme volatility and indecision.",
          "calculation": "Upper Shadow > 2 * Real Body AND Lower Shadow > 2 * Real Body.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Market is highly confused. Often precedes a sharp breakout in the direction of the next strong candle.",
          "interpretationVisual": [
                    {
                              "range": "No Breakout",
                              "label": "Wait",
                    ...
                    {
                              "range": "Bullish Confirmation",
                              "label": "Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Bearish Confirmation",
                              "label": "Sell",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Trade the breakout of the High Wave candle's extremes rather than trying to predict the direction.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "shaved_head",
          "title": "Shaved Head",
          "description": "A candlestick lacking an upper shadow entirely, meaning the open or close was exactly the high of the session.",
          "calculation": "High == Max(Open, Close).",
          "weight": "1.0% of Technical Engine",
          "interpretation": "A bullish shaved head (close=high) shows strong finish by buyers. A bearish shaved head (open=high) shows immediate rejection.",
          "interpretationVisual": [
                    {
                              "range": "Bullish Shaved",
                              "label": "Strength",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Bearish Shaved",
                              "label": "Weakness",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "A bullish shaved head closing above resistance implies strong breakout continuation.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "shaved_bottom",
          "title": "Shaved Bottom",
          "description": "A candlestick that has no lower shadow, meaning the open or close was precisely the low of the session.",
          "calculation": "Low == Min(Open, Close).",
          "weight": "1.0% of Technical Engine",
          "interpretation": "A bearish shaved bottom (close=low) indicates intense late selling. A bullish shaved bottom (open=low) shows immediate buying from the open.",
          "interpretationVisual": [
                    {
                              "range": "Bearish Shaved",
                              "label": "Weakness",
          ...
          "proTip": "Use shaved bottoms to refine support levels, as they indicate precise price points where buying/selling started.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A two-candle reversal pattern where a smaller bearish candle is completely eclipsed by a larger bullish candle.",
          "calculation": "Candle 1 Close < Candle 1 Open AND Candle 2 Close > Candle 2 Open AND Candle 2 Open < Candle 1 Close AND Candle 2 Close > Candle 1 Open.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Signals a powerful shift in momentum from sellers to buyers, particularly potent at support levels.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Support",
                              "label": "Strong Buy",
                              "color": "text-emerald-500"
                    },
                    {
                    ...
                    {
                              "range": "Resistance Hit",
                              "label": "Caution",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "Engulfing patterns that swallow more than one previous candle have a dramatically higher success rate.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A two-candle reversal pattern where a small bullish candle is completely covered by the body of a subsequent bearish candle.",
          "calculation": "Candle 1 Close > Candle 1 Open AND Candle 2 Close < Candle 2 Open AND Candle 2 Open > Candle 1 Close AND Candle 2 Close < Candle 1 Open.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A stark warning that buyers have capitulated to sellers. Marks impending downside, especially after a prolonged rally.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Resistance",
                              "label": "Strong Sell",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Mid-Trend",
                              "label": "Continuation Down",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Support Hit",
          ...
          "proTip": "A bearish engulfing pattern on a weekly chart is one of the most reliable macroeconomic top signals.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          "id": "tweezer_tops",
          "title": "Tweezer Tops",
          "description": "A bearish reversal pattern featuring two or more consecutive candles with matching or nearly identical highs.",
          "calculation": "Abs(High 1 - High 2) <= 0.05% of Price AND Trend == Uptrend.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Indicates a firm resistance level where buyers repeatedly fail to push the price higher.",
          "interpretationVisual": [
                    {
                              "range": "Rejected",
                              "label": "Sell Signal",
                    ...
                    {
                              "range": "Broken Resistance",
                              "label": "Invalidated",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Tweezer Tops are highly effective when the first candle is a strong bullish candle and the second is a Doji or Shooting Star.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A bullish reversal formation marked by two or more consecutive candles registering the exact same low price.",
          "calculation": "Abs(Low 1 - Low 2) <= 0.05% of Price AND Trend == Downtrend.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Identifies strong localized support, as sellers are unable to penetrate below the established floor.",
          "interpretationVisual": [
                    {
                              "range": "Supported",
                              "label": "Buy Signal",
                    ...
                    {
                              "range": "Broken Support",
                              "label": "Invalidated",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "If Tweezer Bottoms coincide with a Fibonacci retracement level (e.g., 61.8%), the probability of reversal soars.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "piercing_line",
          "title": "Piercing Line",
          "description": "A two-day bullish reversal pattern where a strong bearish candle is followed by a bullish candle that gaps down but closes above the midpoint of the first candle.",
          "calculation": "Candle 1 Close < Open AND Candle 2 Open < Low 1 AND Candle 2 Close > (Candle 1 Open + Candle 1 Close) / 2.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Shows aggressive dip buying that overwrites bearish sentiment. The deeper the penetration into the prior day's body, the stronger the signal.",
          "interpretationVisual": [
                    {
                              "range": ">50% Penetration",
                              "label": "Strong Buy",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "A volume spike on the piercing candle confirms institutional buying.",
          "dataSources": "Price Action OHLC, Volume",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A two-day bearish reversal pattern consisting of a bullish candle followed by a bearish one that opens higher but closes well into the bullish body.",
          "calculation": "Candle 1 Close > Open AND Candle 2 Open > High 1 AND Candle 2 Close < (Candle 1 Open + Candle 1 Close) / 2.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "A warning sign of fading upside momentum. Sellers have seized control and forced the price back down.",
          "interpretationVisual": [
                    {
                              "range": ">50% Penetration",
                              "label": "Strong Sell",
                    ...
                    {
                              "range": "Gap Filled Upside",
                              "label": "Invalidated",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "It's a top-tier short signal if the dark cloud cover aligns with a historical resistance zone or an overbought RSI.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A two-candle pattern where a small bullish body is completely contained within the preceding large bearish body, indicating slowing selling momentum.",
          "calculation": "Candle 1 Close < Open AND Candle 2 Close > Open AND Candle 2 High < Candle 1 Open AND Candle 2 Low > Candle 1 Close.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Signifies that the downtrend is losing steam. Traders should wait for a bullish breakout above the first candle's high.",
          "interpretationVisual": [
                    {
                              "range": "Contained",
                              "label": "Watch",
          ...
          "proTip": "Think of it as an 'inside day.' The tighter the range of the second candle, the more explosive the resulting breakout.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A two-candle setup where a large bullish candle is followed by a small bearish candle fully enclosed within the first candle's range.",
          "calculation": "Candle 1 Close > Open AND Candle 2 Close < Open AND Candle 2 High < Candle 1 Close AND Candle 2 Low > Candle 1 Open.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Indicates buying pressure has suddenly evaporated. Watch for a breakdown below the pattern for a short entry.",
          "interpretationVisual": [
                    {
                              "range": "Contained",
                              "label": "Watch",
          ...
          "proTip": "A bearish harami on low volume suggests a mere pause, but on high volume, it signals distribution.",
          "dataSources": "Price Action OHLC, Volume",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "harami_cross",
          "title": "Harami Cross",
          "description": "A Harami pattern where the second candle is a Doji (virtually identical open and close), signifying extreme indecision.",
          "calculation": "Harami Pattern Rules apply AND Abs(Candle 2 Open - Candle 2 Close) <= 0.1% of Price.",
          "weight": "1.8% of Technical Engine",
          "interpretation": "More significant than a standard Harami. The Doji emphasizes complete paralysis between bulls and bears.",
          "interpretationVisual": [
                    {
                              "range": "Downtrend Cross",
                              "label": "Bullish Reversal",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Harami Crosses at market tops are generally more reliable signals than those at market bottoms.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          "id": "morning_star",
          "title": "Morning Star",
          "description": "A powerful three-candle bullish reversal pattern: a long bearish candle, a small-bodied candle gapping down, and a long bullish candle.",
          "calculation": "Candle 1 Bearish AND Candle 2 Gap Down & Small Body AND Candle 3 Bullish closing above Candle 1 midpoint.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "A definitive bottoming formation. The middle candle shows exhaustion, and the third candle confirms a new uptrend.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Reversal",
                              "label": "Strong Buy",
                    ...
                    {
                              "range": "Failed Pattern",
                              "label": "Bearish",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "If the third candle has strong volume and closes above the first candle's open, the setup is nearly flawless.",
          "dataSources": "Price Action OHLC, Volume",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          "id": "evening_star",
          "title": "Evening Star",
          "description": "A three-candle bearish reversal pattern signaling a top: a tall bullish candle, a small gapping candle, and a large bearish candle.",
          "calculation": "Candle 1 Bullish AND Candle 2 Gap Up & Small Body AND Candle 3 Bearish closing below Candle 1 midpoint.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Signals the end of an uptrend. The star highlights euphoria, while the final candle confirms seller domination.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Reversal",
                              "label": "Strong Sell",
          ...
          "proTip": "An Evening Star with a Doji as the middle candle (Evening Doji Star) is a much stronger reversal signal.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A bullish candlestick pattern consisting of three consecutive long-bodied positive candles that open within the previous candle's body.",
          "calculation": "Three successive bullish candles with Higher Highs and Higher Lows, opening within the prior real body.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A robust signal of a strong uptrend reversal from a bear market, showing persistent and steady buying pressure.",
          "interpretationVisual": [
                    {
                              "range": "Strong Momentum",
                              "label": "Hold/Buy",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Be wary of extremely large 'soldiers', as they can indicate an overbought condition vulnerable to short-term retracement.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A bearish reversal pattern containing three consecutive long-bodied negative candles with consecutively lower closes.",
          "calculation": "Three successive bearish candles with Lower Highs and Lower Lows, opening within the prior real body.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Indicates a decisive market shift to a downtrend. It implies strong, sustained selling pressure over multiple periods.",
          "interpretationVisual": [
                    {
                              "range": "Strong Momentum",
                              "label": "Hold Short",
          ...
          "proTip": "Excellent for confirming a broader downtrend on a weekly timeframe. Ensure bodies are large, not small.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A confirmed Bullish Harami pattern. It consists of a large bearish candle, a smaller bullish candle, and a third bullish candle closing higher.",
          "calculation": "Candle 1 & 2 form Bullish Harami AND Candle 3 Close > Candle 2 High.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Provides confirmation of a trend reversal. The third candle solidifies that the bulls have indeed taken over.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed",
                              "label": "Buy Signal",
          ...
          "proTip": "Trade the breakout of the third candle's high with a stop loss placed directly beneath the Harami's low.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A confirmed Bearish Harami. It includes a large bullish candle, an inside bearish candle, and a third bearish candle that closes below the Harami low.",
          "calculation": "Candle 1 & 2 form Bearish Harami AND Candle 3 Close < Candle 2 Low.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Confirms the bearish reversal of an uptrend. Highly reliable for entering short positions.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed",
                              "label": "Sell Signal",
          ...
          "proTip": "If the third candle closes below the open of the very first large bullish candle, the signal is significantly amplified.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A confirmed Bullish Engulfing pattern. It consists of a bearish candle, a bullish engulfing candle, and a third bullish candle closing higher.",
          "calculation": "Candle 1 & 2 form Bullish Engulfing AND Candle 3 Close > Candle 2 High.",
          "weight": "2.2% of Technical Engine",
          "interpretation": "A highly robust bullish reversal signal. The engulfing candle shifts momentum, and the third candle confirms the new trend.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed",
                              "label": "Strong Buy",
          ...
          "proTip": "Wait for a slight pullback into the body of the second (engulfing) candle for an optimal, lower-risk entry point.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A confirmed Bearish Engulfing pattern featuring a bullish candle, a bearish engulfing candle, and a third bearish candle continuing downward.",
          "calculation": "Candle 1 & 2 form Bearish Engulfing AND Candle 3 Close < Candle 2 Low.",
          "weight": "2.2% of Technical Engine",
          "interpretation": "Signals high conviction from sellers, formally validating a downward shift after a rally.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed",
                              "label": "Strong Sell",
          ...
          "proTip": "Use this as a definitive signal to exit long positions, especially if it coincides with declining momentum oscillators.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Similar to a Morning Star, but the middle candle is a Doji, meaning extreme indecision precisely at the bottom before reversal.",
          "calculation": "Candle 1 Bearish AND Candle 2 Doji Gap Down AND Candle 3 Bullish Close > Candle 1 Midpoint.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "An intensely strong bullish reversal. The Doji signifies perfect equilibrium, followed immediately by aggressive buying.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Reversal",
                              "label": "Strong Buy",
          ...
          "proTip": "If the third candle gaps up away from the Doji, creating an 'island bottom', the setup is highly explosive.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "An Evening Star formation where the middle candle is a Doji, acting as a profound top reversal indicator.",
          "calculation": "Candle 1 Bullish AND Candle 2 Doji Gap Up AND Candle 3 Bearish Close < Candle 1 Midpoint.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Highlights a total exhaustion of buyers at the peak, leading directly to a fierce sell-off.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Reversal",
                              "label": "Strong Sell",
          ...
          "proTip": "Look for heavy volume on the third bearish candle to ensure institutional sellers are initiating a major leg down.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A rare three-candle reversal pattern. A bearish candle, a Doji gapping below the first, and a bullish candle gapping above the Doji.",
          "calculation": "Candle 1 Bearish AND Candle 2 Doji with Gap Down (Shadows do not overlap) AND Candle 3 Bullish with Gap Up.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "One of the most reliable bottoming signals in existence. The 'abandoned' Doji represents an island of trapped sellers.",
          "interpretationVisual": [
                    {
                              "range": "Gaps Intact",
                              "label": "Absolute Buy",
          ...
          "proTip": "Due to its rarity, if you spot an authentic Bullish Abandoned Baby on a daily chart, allocate higher risk as probability is skewed heavily in your favor.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A highly rare top reversal. Features a bullish candle, a Doji gapping above, and a bearish candle gapping down below the Doji.",
          "calculation": "Candle 1 Bullish AND Candle 2 Doji with Gap Up (No shadow overlap) AND Candle 3 Bearish with Gap Down.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "A definitive, catastrophic top signal. Buyers are trapped on an 'island' and the immediate gap down guarantees panic selling.",
          "interpretationVisual": [
                    {
                              "range": "Gaps Intact",
                              "label": "Absolute Sell",
          ...
          "proTip": "Short the open of the fourth candle and place a hard stop loss just above the high of the abandoned Doji.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A four-candle bullish reversal pattern consisting of two bearish Marubozus, a bearish candle with a long upper shadow, and an engulfing bullish candle.",
          "calculation": "C1 & C2 Bearish Marubozu AND C3 opens lower with long upper shadow into C2 AND C4 Bullish engulfing C3 completely.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Signals sellers overextended themselves on successive days, creating a 'vacuum' that buyers immediately exploit.",
          "interpretationVisual": [
                    {
                              "range": "Confirmed Engulfing",
                              "label": "Buy",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Extremely rare; when found, it often triggers sharp, vertical rallies. Verify with bullish divergence on MACD.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A three-day bullish pattern with a bullish candle sandwiched between two bearish candles, where both bearish candles close at the same support level.",
          "calculation": "C1 Bearish AND C2 Bullish opening higher AND C3 Bearish closing exactly at C1 Close.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Identifies an unyielding floor. The market tried twice to break lower but closed at the exact same level.",
          "interpretationVisual": [
                    {
                              "range": "Floor Holds",
                              "label": "Buy Signal",
          ...
          "proTip": "Wait for the fourth day to trade above the high of the third day to confirm the support level is valid.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "One of the most powerful patterns. A bearish candle followed by a massive gap up into a bullish candle, with no overlapping shadows.",
          "calculation": "C1 Bearish AND C2 Bullish AND C2 Open >= C1 Open (Gap up over the entire body).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Indicates a violent paradigm shift in market psychology, usually triggered by overnight news or earnings.",
          "interpretationVisual": [
                    {
                              "range": "Massive Gap",
                              "label": "Strong Buy",
                    ...
                    {
                              "range": "Gap Fills Down",
                              "label": "Caution",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Never fade a Kicker pattern. It reflects an institutional repricing of the asset.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A fierce top reversal pattern. A bullish candle followed by a devastating gap down into a bearish candle with no shadow overlap.",
          "calculation": "C1 Bullish AND C2 Bearish AND C2 Open <= C1 Open (Gap down below the entire body).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Total devastation of bullish thesis. Usually caused by catastrophic news, marking the start of a deep capitulation phase.",
          "interpretationVisual": [
                    {
                              "range": "Massive Gap",
                              "label": "Strong Sell",
          ...
          "proTip": "The wider the gap between the two candles, the stronger the ensuing downtrend will be. Short rallies into the gap.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "The foundational Elliott Wave structure detailing a 5-wave motive phase, moving in the direction of the larger primary trend.",
          "calculation": "Wave 2 cannot retrace >100% of W1. Wave 3 cannot be the shortest. Wave 4 cannot overlap W1.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "Identifies the core directional thrust of the market. Trading in the direction of Wave 3 provides the highest risk-adjusted returns.",
          "interpretationVisual": [
                    {
                              "range": "Wave 3 Active",
                              "label": "Strong Trend",
          ...
          "proTip": "Wave 3 typically extends to the 1.618 Fibonacci extension of Wave 1. That is your primary profit target.",
          "dataSources": "Price Action, Fractals",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "High"
            },
{
          "id": "elliott_wave_abc_correction",
          "title": "Elliott Wave (ABC Correction)",
          "description": "A 3-wave counter-trend move that follows a 5-wave impulse sequence, retracing part of the primary trend.",
          "calculation": "Wave A (5 or 3 waves), Wave B (3 waves retracing A), Wave C (5 waves exceeding A).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Used to find optimal entry points for the next impulse wave. The end of Wave C is the ultimate 'buy the dip' zone.",
          "interpretationVisual": [
                    {
                              "range": "Wave C Target Hit",
                              "label": "Buy Zone",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Wave C often equals the length of Wave A (1:1 measured move), or the 1.618 extension of Wave A.",
          "dataSources": "Price Action, Fractals",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A sharp, deep ABC corrective pattern characterized by a 5-3-5 internal sub-wave structure.",
          "calculation": "Internal structure: 5 waves down (A), 3 waves up (B), 5 waves down (C). B retraces < 61.8% of A.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "A ZigZag creates a steep correction, often found in Wave 2. It shakes out weak hands before a massive Wave 3 launch.",
          "interpretationVisual": [
                    {
                              "range": "Deep Retracement",
                              "label": "Strong Buy Setup",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Wave B Counter",
                              "label": "Sell Rally",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "Look for confluence of the end of Wave C with the 61.8% or 78.6% retracement of the prior impulse wave.",
          "dataSources": "Price Action, Fractals",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A sideways ABC corrective pattern with a 3-3-5 internal structure, indicating a strong underlying trend.",
          "calculation": "Wave B retraces > 90% of Wave A. Wave C often terminates near the bottom of Wave A.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Flats occur mostly in Wave 4. They show market indecision but strong underlying support, leading to a steady continuation.",
          "interpretationVisual": [
                    {
                              "range": "Sideways Channel",
                              "label": "Accumulate",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "In a 'Running Flat', Wave C fails to reach the bottom of Wave A, signaling an exceptionally strong upcoming bullish move.",
          "dataSources": "Price Action, Fractals",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A consolidating 5-wave corrective pattern (A-B-C-D-E) that compresses price action before a violent breakout.",
          "calculation": "Internal 3-3-3-3-3 structure bounded by converging trendlines.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Triangles occur prior to the final motive wave (Wave 4 or Wave B). They guarantee a sharp, swift thrust upon completion.",
          "interpretationVisual": [
                    {
                              "range": "Wave E Touch",
                              "label": "Optimal Entry",
          ...
          "proTip": "The post-triangle breakout distance is often equal to the widest part of the triangle added to the breakout point.",
          "dataSources": "Price Action, Trendlines",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A prolonged ranging phase where smart money covertly absorbs supply from retail traders before initiating a new bull market.",
          "calculation": "Identified by phases A through E, containing Preliminary Support, Selling Climax, Automatic Rally, and Secondary Tests.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Do not buy the initial range. Wait for the Spring or the Sign of Strength (Phase C/D) to join institutional buyers.",
          "interpretationVisual": [
                    {
                              "range": "Phase D (Markup)",
                              "label": "Strong Buy",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Volume should consistently dry up during downswings in the range and expand during upswings to confirm accumulation.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A topping phase where institutional 'smart money' offloads their holdings to uninformed retail buyers before a bear market.",
          "calculation": "Characterized by Preliminary Supply, Buying Climax, Automatic Reaction, and Upthrusts.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Prepare for a major downtrend. The key event is the Upthrust After Distribution (UTAD) trapping late bulls.",
          "interpretationVisual": [
                    {
                              "range": "Phase D (Markdown)",
                              "label": "Strong Sell",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "Look for high volume on narrow-spread up days. This indicates massive institutional selling into retail demand.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Swing/Position",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A terminal shakeout in the Accumulation phase where price briefly breaks below support to trap bears and trigger stop-losses.",
          "calculation": "Price drops below the established support line of the trading range but immediately reverses and closes back inside it.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "The ultimate institutional bear trap. Once price re-enters the range, it is a high-conviction buy signal for a major rally.",
          "interpretationVisual": [
                    {
                              "range": "Successful Spring",
                              "label": "Absolute Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Testing Support",
                              "label": "Watch",
                              "color": "text-yellow-500"
                    },
                    {
          ...
          "proTip": "A Spring on relatively low volume is ideal, meaning supply is completely exhausted and bears are weak.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "The bearish counterpart to the Spring. Price temporarily breaches the top of a distribution range to trap breakout traders.",
          "calculation": "Price breaks above established resistance, triggers stops, and violently closes back inside the trading range.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "A fake breakout designed to manufacture liquidity for institutions to short. Signals an imminent, sharp decline.",
          "interpretationVisual": [
                    {
          ...
          "proTip": "Short the market the moment an hourly candle closes back inside the range after an Upthrust. Place stops just above the spike.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A major bullish price advance on expanding spread and volume, signaling that accumulation is complete and the markup phase has begun.",
          "calculation": "A wide-range bullish candle breaking out of a Wyckoff range accompanied by >150% average volume.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "The undeniable footprint of institutional demand. The asset will now likely enter a sustained uptrend.",
          "interpretationVisual": [
                    {
                              "range": "Markup Phase",
                              "label": "Strong Buy",
          ...
          "proTip": "Do not chase the initial SOS. Wait for the 'Last Point of Support' (LPS)—a low-volume pullback—to enter safely.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Daily/Weekly",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A sudden, catastrophic price drop on extreme volume where panic selling meets massive institutional buying.",
          "calculation": "Extremely wide price spread down, highest volume in months, followed by a close off the deep lows.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Marks the definitive end of a downtrend. 'Smart money' is absorbing all the panic supply.",
          "interpretationVisual": [
                    {
                              "range": "Climax Reversal",
                              "label": "Buy/Cover",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Secondary Test",
                              "label": "Accumulate",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Continued Dump",
                              "label": "Stand Aside",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "The low of the Selling Climax forms the unbreakable floor of the subsequent Accumulation range.",
          "dataSources": "Price Action, Volume",
          "updateFrequency": "Daily/Weekly",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "The last bearish candle before a strong bullish impulse that breaks market structure, representing an institutional buy zone.",
          "calculation": "Identify the final down-candle prior to an upward displacement that breaks a swing high. Zone = High to Low of that down-candle.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "Institutions leave pending buy limit orders here. When price retraces back to this zone, expect a strong bullish bounce.",
          "interpretationVisual": [
                    {
                              "range": "Inside Block",
                              "label": "Strong Buy",
                    ...
                    {
                              "range": "Block Violated",
                              "label": "Trend Shift Bearish",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Refine the entry to the 50% level (mean threshold) of the Order Block. If price closes below the 50% mark, the block is invalid.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "The final bullish candle preceding a massive downward drop that breaks market structure, acting as an institutional sell zone.",
          "calculation": "Identify the last up-candle before a downward displacement that breaks a swing low. Zone = High to Low of that up-candle.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "A magnetic zone for future price action. Rallies back into this block will face heavy institutional selling pressure.",
          "interpretationVisual": [
                    {
                              "range": "Inside Block",
                              "label": "Strong Sell",
                    ...
                    {
                              "range": "Block Violated",
                              "label": "Trend Shift Bullish",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Only trade bearish order blocks that are aligned with the higher timeframe macro trend.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A failed Order Block. A previous swing high/low that failed to take out liquidity, was broken through, and is now tested from the other side.",
          "calculation": "Identify an Order Block that price completely smashed through. Retest of that same zone acts as reversed Support/Resistance.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Institutions are 'mitigating' losing positions at breakeven. It flips a known buy zone into a sell zone (or vice versa).",
          "interpretationVisual": [
                    {
                              "range": "Retesting",
          ...
          "proTip": "Mitigation blocks lack the 'stop hunt' element. Use them strictly as traditional S/R flips with tight stops.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          "id": "breaker_block",
          "title": "Breaker Block",
          "description": "An Order Block that successfully swept liquidity (Stop Hunt) but was then aggressively broken. The ultimate S/R flip.",
          "calculation": "Price takes out a major high/low, creating a block, then violent displacement breaks through that block in the opposite direction.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "A highly robust setup. A bearish Breaker occurs when a bullish block that took out an old high is smashed downwards. Retest is a short.",
          "interpretationVisual": [
                    {
                              "range": "Retesting Breaker",
                              "label": "High Conviction Entry",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Pending",
          ...
          "proTip": "Breakers are higher probability than Mitigation Blocks because the liquidity sweep (stop hunt) has already occurred.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A massive, rapid price move where only buying or only selling occurs, leaving behind a gap in historical liquidity.",
          "calculation": "A series of large, long-bodied candles with little to no overlap between the shadows.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "The market abhors a vacuum. Price will eventually be magnetically drawn back to fill this void and rebalance the order book.",
          "interpretationVisual": [
                    {
                              "range": "Void Unfilled",
                    ...
                    {
                              "range": "Void Filled",
                              "label": "Look for Reversal",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Do not trade 'into' the void blindly. Use the void as a take-profit target for trades originating from Order Blocks.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A smart money manipulation tactic where price briefly breaks a major swing high/low just to trigger retail stop-losses, then reverses.",
          "calculation": "Price pushes < 1% past a 20-day high/low, wicks immediately, and closes back inside the previous range.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "Liquidity is engineered. Institutions absorb the triggered retail stops to fuel a massive move in the opposite direction.",
          "interpretationVisual": [
                    {
                              "range": "Sweep Occurring",
                              "label": "Wait for Close",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Confirmed Sweep",
                              "label": "Fade Breakout",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "The best stop hunts occur during major economic news releases or market opens. Fade the initial spike.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A three-candle pattern highlighting a sudden imbalance in price delivery, marked by a gap between the shadows of the first and third candles.",
          "calculation": "Bullish: C3 Low > C1 High. Bearish: C3 High < C1 Low. The gap between them is the FVG.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Price will inevitably return to 'fill' or test this gap. It acts as an incredibly precise entry zone for trend continuation.",
          "interpretationVisual": [
                    {
                              "range": "Inside FVG",
                              "label": "Optimal Entry",
                    ...
                    {
                              "range": "Closed Through",
                              "label": "Invalidated",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Buy the consequent encroachment (exact 50% midpoint) of the FVG for the highest sniper-like precision.",
          "dataSources": "Price Action OHLC",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "The specific price level within a given time period where the highest volume of trading occurred.",
          "calculation": "Identified via Volume Profile as the longest horizontal volume node.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Acts as the market's center of gravity. Extremely sticky level; acts as magnetic support in pullbacks and resistance in rallies.",
          "interpretationVisual": [
                    {
                              "range": "Price at POC",
                              "label": "Consolidation",
          ...
          "proTip": "A 'Naked POC' (a previous day's POC that hasn't been touched yet) is a 90% probability target for mean reversion trades.",
          "dataSources": "Volume Profile",
          "updateFrequency": "Intraday/Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "The upper and lower boundaries of the price range where 70% of the trading volume occurred.",
          "calculation": "Calculate total volume. Find POC. Add volume nodes above/below until 70% of total volume is captured. Boundaries are VAH/VAL.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Trade the edges. Rejections at VAH/VAL lead to moves back to the POC. Breakouts of VAH/VAL signify trend discovery.",
          "interpretationVisual": [
                    {
                              "range": "Rejecting VAH",
                              "label": "Short to POC",
                    ...
                    {
                              "range": "Outside Value Area",
                              "label": "Trend Continuation",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "The 80% Rule: If price opens outside the Value Area but closes two consecutive candles back inside it, there is an 80% chance it targets the opposite side.",
          "dataSources": "Volume Profile",
          "updateFrequency": "Intraday/Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A noise-filtering indicator that draws lines connecting significant swing highs and lows, ignoring minor price fluctuations.",
          "calculation": "Filters out all price moves smaller than a user-defined percentage threshold (e.g., 5%).",
          "weight": "1.0% of Technical Engine",
          "interpretation": "Not a predictive tool. Used strictly to clarify market structure, making Elliott Waves and chart patterns obvious.",
          "interpretationVisual": [
                    {
                              "range": "Higher Highs/Lows",
                              "label": "Uptrend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Lower Highs/Lows",
                              "label": "Downtrend",
                              "color": "text-red-500"
                    },
                    {
          ...
          "proTip": "Use the ZigZag nodes to easily draw Fibonacci retracements without subjective bias.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time (Lags at current candle)",
          "confidenceImpact": "Moderate"
            },
{
          "id": "zigzag_oscillator",
          "title": "ZigZag Oscillator",
          "description": "A momentum variation of the ZigZag tool that oscillating around a zero line to measure the absolute depth of swing waves.",
          "calculation": "Measures the distance from the last ZigZag pivot to the current price, normalized as an oscillator.",
          "weight": "1.0% of Technical Engine",
          "interpretation": "Identifies when a swing wave is becoming statistically overextended relative to historical wave lengths.",
          "interpretationVisual": [
                    {
                              "range": "Extreme Positive",
                              "label": "Overbought Wave",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Extreme Negative",
                              "label": "Oversold Wave",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Near Zero",
                              "label": "Wave Beginning",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "When the oscillator reaches historical extremes, look for a reversal candlestick to snipe the top/bottom of the wave.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Low"
            },
{
          ...
          "description": "A visual cluster of multiple moving averages (often 8 to 15) of varying lengths layered on a chart.",
          "calculation": "Plots SMA or EMA of lengths 10, 20, 30, 40, 50, 60... consecutively.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "When the ribbon twists and expands, a strong trend is forming. When it compresses, a breakout is imminent.",
          "interpretationVisual": [
                    {
                              "range": "Fanned Out Upwards",
                              "label": "Strong Uptrend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Fanned Out Downwards",
                              "label": "Strong Downtrend",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Tangled/Compressed",
                              "label": "Indecision/Squeeze",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "Wait for the entire ribbon to compress into a tight knot; the subsequent expansion is highly explosive.",
          "dataSources": "Price Action (Close)",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "An advanced ribbon utilizing two distinct groups of EMAs to measure the behavior of short-term traders vs long-term investors.",
          "calculation": "Short group: EMAs 3, 5, 8, 10, 12, 15. Long group: EMAs 30, 35, 40, 45, 50, 60.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Look for the short-term group to cross the long-term group. If both groups widen, institutional money is driving a mega-trend.",
          "interpretationVisual": [
                    {
                              "range": "Groups Diverging Up",
                              "label": "Strong Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Groups Intersecting",
                              "label": "Trend Shift",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Groups Diverging Down",
                              "label": "Strong Sell",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Buy the dip when the short-term group pulls back into the long-term group and bounces.",
          "dataSources": "Price Action (Close)",
          "updateFrequency": "Real-time",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A derivative of multiple moving averages combined into an oscillator to visualize trend stability and extremes.",
          "calculation": "Uses the highest high and lowest low of a moving average ribbon to plot an oscillator bandwidth.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Values staying near the zero line indicate a stable, relentless trend. Wild spikes indicate chaotic volatility and pending reversals.",
          "interpretationVisual": [
                    {
                              "range": "Flat Near Zero",
                              "label": "Stable Trend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Spiking High",
                              "label": "Overbought Danger",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Spiking Low",
                              "label": "Oversold Danger",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Use this as a secondary confirmation tool to avoid entering trends that are mathematically exhausted.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Low"
            },
{
          "id": "gann_fan",
          "title": "Gann Fan",
          "description": "A series of diagonal lines extending from a major peak or trough, based on W.D. Gann's theory of price and time geometry.",
          "calculation": "Plots 9 angles, the most important being the 1x1 line (45 degrees), representing one unit of price per one unit of time.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "If price is above the 1x1 line, the market is bullish. Breaking below it signals a massive trend reversal. Angles act as dynamic S/R.",
          "interpretationVisual": [
                    {
                              "range": "Above 1x1 Line",
                              "label": "Bullish",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Testing 1x1 Line",
                              "label": "Critical Support",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Below 1x1 Line",
                              "label": "Bearish",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "A break of the 1x1 line almost always leads to a fast, violent drop to the 2x1 line.",
          "dataSources": "Price, Time Geometry",
          "updateFrequency": "Static (Drawn from Pivot)",
          "confidenceImpact": "Moderate"
            },
{
          "id": "gann_square",
          "title": "Gann Square",
          "description": "An esoteric time and price tool that forecasts future resistance levels based on squaring historical highs/lows.",
          "calculation": "Uses mathematical squares (e.g., Square of 9 or 144) overlaid on chart grids to predict precise turning points.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Provides fixed dates and price levels where major trend changes are mathematically destined to occur.",
          "interpretationVisual": [
                    {
                              "range": "Approaching Node",
                              "label": "Prepare Reversal",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Rejecting Node",
                              "label": "Trade Reversal",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Breaking Node",
          ...
          "proTip": "Gann Squares are highly controversial. Only use them in confluence with heavy Volume Profile resistance.",
          "dataSources": "Price, Time Geometry",
            ...
            },
{
          ...
          "description": "A 3-point channel tool using three consecutive major highs/lows to project a median line and dynamic support/resistance channels.",
          "calculation": "P1, P2, P3. Median line bisects P2 and P3 from P1. Upper/lower prongs are drawn parallel.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Price gravitates to the median line 80% of the time. Trading bounces off the outer prongs toward the median is highly effective.",
          "interpretationVisual": [
                    {
                              "range": "Lower Prong",
                              "label": "Buy to Median",
                    ...
                    {
                              "range": "Median Line",
                              "label": "Take Profit/Pivot",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Upper Prong",
                              "label": "Sell to Median",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "If price fails to reach the median line and reverses, it indicates an extreme shift in momentum and a likely breakout of the pitchfork.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static (Drawn from Pivots)",
          "confidenceImpact": "High"
            },
{
          "id": "schiff_pitchfork",
          "title": "Schiff Pitchfork",
          "description": "A modified Pitchfork where the origin point (P1) is shifted to the halfway point between P1 and P2 on the Y-axis.",
          "calculation": "Origin = (Price P1 + Price P2) / 2. Prongs drawn same as standard pitchfork.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Used when a standard Andrews Pitchfork is too steep to contain price action. Provides a shallower, more realistic trend channel.",
          "interpretationVisual": [
                    {
                              "range": "Lower Prong",
                              "label": "Buy",
          ...
          "proTip": "Apply the Schiff modification explicitly during parabolic bull markets when standard geometry breaks down.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Another modification where the origin is shifted on the X-axis (time) to the halfway point between P1 and P2.",
          "calculation": "Origin = (Time P1 + Time P2) / 2. Standard pitchfork geometry applies.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Useful for capturing prolonged, grinding trends where price action is highly compressed over time.",
          "interpretationVisual": [
                    {
          ...
          "proTip": "Combine with a standard pitchfork. The intersections of the median lines create powerful 'energy centers' for reversals.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "Horizontal lines indicating where support and resistance are likely to occur based on the golden ratio, applied to a previous price swing.",
          "calculation": "Measures a swing High/Low and projects 23.6%, 38.2%, 50%, 61.8%, and 78.6% levels internally.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Used to 'buy the dip' in an uptrend. The 61.8% level is the 'golden pocket' and the most reactive bounce zone.",
          "interpretationVisual": [
                    {
                              "range": "38.2% Level",
                              "label": "Shallow Pullback Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "61.8% Level",
                              "label": "Golden Pocket Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": ">78.6% Level",
          ...
          "proTip": "Confluence is key. A 61.8% retracement that aligns exactly with a prior Order Block has a near 90% bounce probability.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "Projects targets beyond the 100% mark of a price swing, used to identify take-profit levels in new, uncharted territory.",
          "calculation": "Uses 3 points (A-B-C pullback). Projects 127.2%, 161.8%, 200%, and 261.8% levels based on the A-B impulse.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "When an asset hits all-time highs, extensions are the only mathematical way to calculate where the rally will exhaust.",
          "interpretationVisual": [
                    {
                              "range": "100% Extension",
                              "label": "Measured Move TP",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "161.8% Extension",
                              "label": "Golden Target TP",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "261.8% Extension",
                              "label": "Climax Top",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "The 1.618 extension is the absolute best place to take 50% of your profits off the table during a Wave 3 breakout.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Vertical lines placed on the chart based on the Fibonacci sequence to predict WHEN major volatility or reversals will happen, not where.",
          "calculation": "Drawn from a major pivot, adding vertical lines at periods 1, 2, 3, 5, 8, 13, 21, 34, 55, etc.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Look for trend changes or explosive moves adjacent to the vertical time lines. Ignore price, focus only on the X-axis.",
          "interpretationVisual": [
                    {
                              "range": "Approaching Zone",
                              "label": "Prepare for Volatility",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "On the Line",
                              "label": "Pivot Expected",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Between Zones",
          ...
          "proTip": "Fib Time Zones are largely inaccurate in crypto, but highly respected in forex and commodities markets.",
          "dataSources": "Time Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Low"
            },
{
          ...
          "description": "Curved lines drawn from a baseline connecting a high and low, providing dynamic support/resistance that factors in both time and price.",
          "calculation": "Draws semi-circles centered on the second pivot point, intersecting the baseline at 38.2%, 50%, and 61.8%.",
          "weight": "1.5% of Technical Engine",
          "interpretation": "Acts like standard retracements but curving outward over time. Prices will often ride the arc or sharply bounce off it.",
          "interpretationVisual": [
                    {
                              "range": "Approaching Arc",
                              "label": "Dynamic Support",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Bouncing off 61.8%",
                              "label": "Buy",
                              "color": "text-emerald-500"
                    },
                    {
          ...
          "proTip": "Zoom levels distort arcs on standard charts. You must 'square the chart' (1:1 aspect ratio) for them to be mathematically valid.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Low"
            },
{
          "id": "fibonacci_fan",
          "title": "Fibonacci Fan",
          "description": "Diagonal trendlines based on Fibonacci ratios to gauge support and resistance levels across time.",
          "calculation": "A vertical line is drawn from peak to trough. Invisible horizontal Fib lines are drawn. Fan lines extend from the start to these intersections.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "A break of the 38.2% fan line suggests a move to the 61.8% line. A break of the 61.8% line indicates complete trend reversal.",
          "interpretationVisual": [
                    {
                              "range": "Above 38.2% Line",
                              "label": "Strong Trend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Between 38.2% and 61.8%",
                              "label": "Consolidation",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Below 61.8% Line",
                              "label": "Trend Reversal",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Combine Fib Fans with Fib Retracements. The geometric intersections create 'clusters' of massive resistance.",
          "dataSources": "Swing Pivots",
          "updateFrequency": "Static",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A purely mathematical calculation of support and resistance levels used primarily by day traders, based on the prior day's HLC.",
          "calculation": "Pivot = (High + Low + Close) / 3. R1 = (2 * Pivot) - Low. S1 = (2 * Pivot) - High.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "If price opens above the central Pivot, bias is bullish targeting R1/R2. If it opens below, bias is bearish targeting S1/S2.",
          "interpretationVisual": [
                    {
                              "range": "Above Pivot",
                              "label": "Bullish Bias",
          ...
          "proTip": "The most successful day trading strategy is fading price at R2 or S2 when it coincides with an RSI divergence.",
          "dataSources": "Previous Day OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A variation of standard pivots that heavily weights the previous period's closing price over the high and low.",
          "calculation": "Pivot = (High + Low + 2 * Close) / 4. S/R levels are derived from this weighted pivot.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Provides a more responsive central pivot, highly favored in fast-moving intraday markets like indices or forex.",
          "interpretationVisual": [
                    {
                              "range": "Above Woodie Pivot",
                              "label": "Bullish Bias",
                              "color": "text-emerald-500"
                    },
                    {
                    ...
                    {
                              "range": "Below Woodie Pivot",
                              "label": "Bearish Bias",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Ignore R3/S3 in Woodie's system; focus strictly on the interaction with the central pivot and R1/S1.",
          "dataSources": "Previous Day OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A sophisticated pivot system designed specifically to trade mean reversion and explosive breakouts using 8 levels.",
          "calculation": "Focuses on L3, L4 (Support) and H3, H4 (Resistance) using complex multiplier fractions of the previous day's range.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Mean Reversion: Short H3, Long L3. Breakout: Long a break of H4, Short a break of L4.",
          "interpretationVisual": [
                    {
                              "range": "Between L3 and H3",
                              "label": "Chop / Range",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Breakout > H4",
                              "label": "Explosive Long",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Breakdown < L4",
                              "label": "Explosive Short",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "If price opens outside of H4 or L4, wait for the first 15-minute candle to close. If it pulls back inside, fade the gap.",
          "dataSources": "Previous Day OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Merges standard pivot point methodology with Fibonacci ratios to create highly accurate daily S/R levels.",
          "calculation": "Pivot = (H+L+C)/3. R1 = Pivot + (0.382 * Range). R2 = Pivot + (0.618 * Range).",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Highly effective because it combines two widely used self-fulfilling prophecies into one indicator.",
          "interpretationVisual": [
                    {
                              "range": "At Fib R1/R2",
          ...
          "proTip": "Look for intraday 5-minute candlestick reversals exactly at the R61.8% or S61.8% levels for high RR day trades.",
          "dataSources": "Previous Day OHLC",
          "updateFrequency": "Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Plots trading volume at specific price levels (horizontal histogram) over a user-selected portion of the chart.",
          "calculation": "Aggregates volume-by-price data between a custom Start Time and End Time.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Draw it over a massive consolidation zone. The resulting POC is the ultimate support/resistance line. Avoid trading in low volume nodes.",
          "interpretationVisual": [
                    {
                              "range": "High Volume Node (HVN)",
                              "label": "Sticky / Range",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Low Volume Node (LVN)",
                              "label": "Fast Move Zone",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Point of Control",
                              "label": "Magnet Support",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "Price rips rapidly through Low Volume Nodes (LVNs). Trade breakouts into LVNs for lightning-fast profit realization.",
          "dataSources": "Volume, Price",
          "updateFrequency": "Static",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "A dynamic Volume Profile that continuously recalculates based on whatever chart data is currently visible on your screen.",
          "calculation": "Aggregates volume-by-price strictly for the candles visible in the current viewport.",
          "weight": "3.0% of Technical Engine",
          "interpretation": "Great for quickly scanning different timeframes. Shows the dominant price levels for the immediate macro or micro picture.",
          "interpretationVisual": [
                    {
                              "range": "Above Visible POC",
                              "label": "Bullish Bias",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Below Visible POC",
                              "label": "Bearish Bias",
                              "color": "text-red-500"
                    },
                    {
                              "range": "Trapped in HVN",
                              "label": "Chop",
                              "color": "text-yellow-500"
                    }
          ],
          "proTip": "Be careful: scrolling left or right changes the data. Pinpoint levels using Fixed Range once you find an area of interest.",
          "dataSources": "Volume, Price",
          "updateFrequency": "Real-time (Viewport Dependent)",
          "confidenceImpact": "Moderate"
            },
{
          "id": "volume_profile_session",
          "title": "Volume Profile (Session)",
          "description": "Plots a distinct Volume Profile for every single trading day, outlining daily POCs and Value Areas.",
          "calculation": "Aggregates volume-by-price from the start to the end of a single 24-hour trading session.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "Crucial for day traders. Comparing today's Value Area to yesterday's determines the immediate trend direction.",
          "interpretationVisual": [
                    {
                              "range": "Value Area Higher",
                              "label": "Bullish Trend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Value Area Inside",
                              "label": "Consolidation",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Value Area Lower",
                              "label": "Bearish Trend",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "If price opens outside yesterday's Value Area but fails to break yesterday's POC, fade it back to the open.",
          "dataSources": "Volume, Price",
          "updateFrequency": "Intraday/Daily",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "Market Profile charts built using letters (TPOs) instead of volume, showing how long price spent at specific levels.",
          "calculation": "Each 30-min period is assigned a letter. Letters stack horizontally at price levels they visit.",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Time = Acceptance. If price spends a lot of time at a level, it is considered 'Fair Value'. Spikes are rejected value.",
          "interpretationVisual": [
                    {
                              "range": "Fat Profile (Bell)",
                              "label": "Balanced Market",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Thin/Elongated",
                              "label": "Trend Market",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Single Prints",
                              "label": "Imbalance (Fill Target)",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "'Single Prints' (levels with only one letter) act exactly like Fair Value Gaps and will almost always be revisited.",
          "dataSources": "Price, Time",
          "updateFrequency": "Intraday (30m increments)",
          "confidenceImpact": "High"
            },
{
          "id": "market_profile",
          "title": "Market Profile",
          "description": "The overarching philosophy of combining TPO and Volume Profile to decipher institutional intent based on auction market theory.",
          "calculation": "Synthesis of TPO Value Areas, Initial Balance (first hour range), and POCs.",
          "weight": "4.0% of Technical Engine",
          "interpretation": "Identifies the market as an auction. If buyers are aggressively pushing outside value, join them. If they fail, fade them.",
          "interpretationVisual": [
                    {
                              "range": "Initial Balance Break",
                              "label": "Trend Day Expected",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Responsive Buying",
                              "label": "Revert to Mean",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Failed Auction",
                              "label": "Sharp Reversal",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "The most powerful signal is a 'Failed Auction': Price breaks the Initial Balance, fails immediately, and rips to the opposite side.",
          "dataSources": "Price, Time, Volume",
          "updateFrequency": "Daily",
          "confidenceImpact": "Absolute"
            },
{
          ...
          "description": "The holy grail for institutional execution. Represents the true average price of an asset over the trading day, weighted by volume.",
          "calculation": "Cumulative (Price * Volume) / Cumulative Volume. Resets every session.",
          "weight": "5.0% of Technical Engine",
          "interpretation": "Institutions buy below VWAP and sell above it. Breakouts above VWAP confirm intraday uptrends.",
          "interpretationVisual": [
                    {
                              "range": "Above VWAP",
                              "label": "Bullish Control",
          ...
          "proTip": "Never short a stock in a strong uptrend that bounces directly off the daily VWAP. That is institutional reloading.",
          "dataSources": "Price, Volume",
            ...
            },
{
          "id": "anchored_vwap",
          "title": "Anchored VWAP",
          "description": "A VWAP line that does not reset daily, but is anchored to a specific significant event (earnings, swing high, all-time high).",
          "calculation": "Cumulative (Price * Volume) / Cumulative Volume starting specifically from user-defined timestamp T.",
          "weight": "4.5% of Technical Engine",
          "interpretation": "Shows the breakeven price of all participants since that specific event. Hugely powerful dynamic support/resistance.",
          "interpretationVisual": [
                    {
                              "range": "Above Anchored VWAP",
                              "label": "Bulls in Profit",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Testing Anchored",
                              "label": "Make or Break",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Below Anchored VWAP",
                              "label": "Bears in Profit",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Anchor a VWAP to the highest volume candle on the chart. That line is virtually unbreakable on the first test.",
          "dataSources": "Price, Volume",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Absolute"
            },
{
          "id": "vwap_bands",
          "title": "VWAP Bands",
          "description": "Standard deviation channels plotted above and below the VWAP line, combining the power of VWAP with Bollinger Band volatility logic.",
          "calculation": "VWAP ± (Standard Deviation * Multipliers, typically 1, 2, and 3).",
          "weight": "3.5% of Technical Engine",
          "interpretation": "Provides precise overbought/oversold levels intraday. A touch of the 3rd standard deviation is a near-guaranteed mean reversion scalp.",
          "interpretationVisual": [
                    {
                              "range": "Upper Band (+2/3 SD)",
                    ...
                    {
                              "range": "Lower Band (-2/3 SD)",
                              "label": "Oversold Long",
                              "color": "text-emerald-500"
                    }
          ],
          "proTip": "In a 'trend day', price will 'ride' the +1 or -1 SD band. Do not fade until it breaks back toward the VWAP.",
          "dataSources": "Price, Volume",
          "updateFrequency": "Intraday",
          "confidenceImpact": "High"
            },
{
          ...
          "description": "A linear regression trendline flanked by parallel lines representing standard deviations from that trend.",
          "calculation": "Calculates Linear Regression line, then plots outer bounds at ±2 standard deviations of price variance.",
          "weight": "2.5% of Technical Engine",
          "interpretation": "Defines the mathematical boundaries of a trend. 95% of price action will occur inside the channel. Breakouts are severe anomalies.",
          "interpretationVisual": [
                    {
                              "range": "Lower Boundary Touch",
                              "label": "Buy",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Center Line Cross",
                              "label": "Hold",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Upper Boundary Touch",
                              "label": "Sell",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "A candle closing completely outside the 2nd standard deviation usually results in a vicious snap-back to the center line.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "A moving average-style line that calculates a linear regression over a rolling N-period window, minimizing lag.",
          "calculation": "Plots the end point of a linear regression line mathematically fitted over the last N periods for every single candle.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Hugs price action much closer than a standard moving average. Crossovers act as highly responsive trend-following signals.",
          "interpretationVisual": [
                    {
                              "range": "Curve Sloping Up",
                              "label": "Uptrend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Price Crossing Curve",
                              "label": "Reversal Warning",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Curve Sloping Down",
                              "label": "Downtrend",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "Use a 100-period Linear Regression Curve instead of a 100 SMA to drastically reduce false signals during choppy markets.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            },
{
          ...
          "description": "An advanced, mathematically complex curve fitted to data using non-linear equations, capable of bending to predict parabolic moves.",
          "calculation": "Fits an nth-degree polynomial equation (usually 2nd or 3rd degree) to minimize squared residuals over N periods.",
          "weight": "2.0% of Technical Engine",
          "interpretation": "Uniquely identifies extreme over-extensions in parabolic bull or bear markets where linear models fail completely.",
          "interpretationVisual": [
                    {
                              "range": "Curve Accelerating",
                              "label": "Parabolic Trend",
                              "color": "text-emerald-500"
                    },
                    {
                              "range": "Curve Flattening",
                              "label": "Momentum Dying",
                              "color": "text-yellow-500"
                    },
                    {
                              "range": "Curve Inflection",
                              "label": "Major Reversal",
                              "color": "text-red-500"
                    }
          ],
          "proTip": "When price breaks the polynomial curve after a parabolic advance, it almost instantly triggers an 80% crash. Sell immediately.",
          "dataSources": "Price Action",
          "updateFrequency": "Real-time",
          "confidenceImpact": "Moderate"
            }

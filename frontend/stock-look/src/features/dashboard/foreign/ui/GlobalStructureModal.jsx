                ...
                >
                    ...
                    <div className="shrink-0 p-5 border-t border-white/5 bg-[#0b1220]/80 backdrop-blur-xl z-10">
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
                            ...
                            <div>
                                <div className="text-white/30 uppercase tracking-wider mb-1">Credit</div>
                                <div className="font-mono text-white/80 font-bold">
                                    {card.creditAllocation || '?'}/150
                                </div>
                            </div>
                            <div>
                                <div className="text-white/30 uppercase tracking-wider mb-1">Signal</div>
                                <div className={`font-mono text-white/80 ${card.normalized > 0.3 ? 'text-emerald-400' :
                                    card.normalized < -0.3 ? 'text-red-400' :
                                        'text-yellow-400'
                                    }`}>

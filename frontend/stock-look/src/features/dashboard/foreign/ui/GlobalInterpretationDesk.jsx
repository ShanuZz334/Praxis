        ...
        ">
            ...
            ">
                ...
                <div className="flex items-center gap-3 mb-2 pb-2 border-b border-white/5">
                    <div className="w-6 h-6 rounded-md bg-blue-500/10 flex items-center justify-center border border-blue-500/20 text-blue-400 text-xs">🌍</div>
                    <span className="text-blue-100/90 text-[11px] font-bold tracking-widest uppercase">Global Context</span>
                </div>

                {/* 1. OVERVIEW / USAGE */}
                <div>
                    <h3 className="text-xs font-bold text-white mb-1.5 uppercase tracking-wide opacity-50">What It Measures</h3>
                ...
                <div className="relative pl-1">
                    ...
                    <div className="pl-4">
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-amber-400 text-[10px] font-black tracking-wider uppercase">Key Insight</span>
                        </div>

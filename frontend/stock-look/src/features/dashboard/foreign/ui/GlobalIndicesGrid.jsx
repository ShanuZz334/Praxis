...
export default function GlobalIndicesGrid({ buckets }) {
    ...
    return (
        <div className="bg-background-card-secondary border border-border-subtle-faint rounded-xl p-6 shadow-md h-full flex flex-col hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">

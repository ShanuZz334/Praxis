...
export default function ProDeskPicks({ data }) {
    ...
    return (
        <Card className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto pr-1 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
...
function OptionRow({ item, type }) {
    ...
    return (
        <div className={`p-2.5 md:p-3 rounded-lg border-2 ${border} ${bg} hover:bg-background-subtle transition-colors flex justify-between items-center group`}>

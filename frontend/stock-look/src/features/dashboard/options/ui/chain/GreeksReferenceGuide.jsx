        ...
        <div className="flex-1 overflow-y-auto no-scrollbar space-y-3 pr-1">
            ...
            <div className="px-1 py-1">
                ...
                <div className="space-y-1 text-[9px] text-text-secondary leading-tight line-clamp-2">
                    ...
                    <div className="pt-1 border-t border-border-default/20 mt-1">
                        <span className="text-blue-600 font-medium inline-flex items-center gap-1"><Zap size={9} /> Rising Delta confirms momentum.</span>
                    </div>
                </div>
            </div>
            ...
            <div className="px-1 py-1 border-t border-border-default/10 pt-3">
                ...
                <div className="space-y-1 text-[9px] text-text-secondary leading-tight">
                    ...
                    <div className="pt-1 border-t border-border-default/20 mt-1">
                        <span className="text-purple-600 font-medium inline-flex items-center gap-1"><Zap size={9} /> High Gamma = Scale-able momentum.</span>
                    </div>
                </div>
            </div>
            ...
            <div className="px-1 py-1 border-t border-border-default/10 pt-3">
                ...
                <div className="space-y-1 text-[9px] text-text-secondary leading-tight">
                    ...
                    <div className="pt-1 border-t border-border-default/20 mt-1">
                        <span className="text-orange-600 font-medium inline-flex items-center gap-1"><Zap size={9} /> High Theta favors option sellers.</span>
                    </div>
                </div>
            </div>
            ...
            <div className="px-1 py-1 border-t border-border-default/10 pt-3">
                ...
                <div className="space-y-1 text-[9px] text-text-secondary leading-tight">
                    ...
                    <div className="pt-1 border-t border-border-default/20 mt-1">
                        <span className="text-amber-600 font-medium inline-flex items-center gap-1"><Zap size={9} /> Buy low IV, Sell high IV.</span>
                    </div>
                </div>
            </div>
            ...
            <div className="px-1 py-1 border-t border-border-default/10 pt-3">
                ...
                <div className="space-y-1 text-[9px] text-text-secondary leading-tight">
                    ...
                    <div className="pt-1 border-t border-border-default/20 mt-1">
                        <span className="text-red-600 font-bold inline-flex items-center gap-1"><Zap size={9} /> IV Rank &gt; 60: Selling Zone.</span>
                    </div>
                </div>
            </div>

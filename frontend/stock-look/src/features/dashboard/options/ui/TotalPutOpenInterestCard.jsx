...
export default function TotalPutOpenInterestCard({ cardId, liveData = null, manualOverride, lastUpdated, tradingMode = 'swing' }) {
    ...
    const { score, bias } = { ...{ score: rawScore, bias: rawBias }, ...applyModeAdjustment({ score: rawScore, bias: rawBias }, 'total_put_oi', tradingMode) };

...
export default function FundamentalGrid({ cards, viewMode, sortMode = "score_desc", onCardClick, data, selectedCategory, manualOverrides, resolveTime, rawScores }) {
  const { useOrbNav, tradingMode } = useTheme();
  ...
  const getHardcodedNode = (cardId) => {
    switch(cardId) {
        case CARD_REGISTRY.pe_ratio.id: return <PERatioCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.pe_ratio} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.pe_ratio.id)} />;
        case CARD_REGISTRY.forward_pe.id: return <ForwardPECard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.forward_pe} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.forward_pe.id)} />;
        case CARD_REGISTRY.pb_ratio.id: return <PBRatioCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.pb_ratio} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.pb_ratio.id)} />;
        case CARD_REGISTRY.ev_ebitda.id: return <EVEbitdaCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.ev_ebitda} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.ev_ebitda.id)} />;
        ...
        case CARD_REGISTRY.fii_dii_flow.id: return <FIIDIIFlowCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverrides={manualOverrides} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.fii_dii_flow.id)} />;
        ...
        case CARD_REGISTRY.roe.id: return <ROECard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.roe} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.roe.id)} />;
        case CARD_REGISTRY.roce.id: return <ROCECard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.roce} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.roce.id)} />;
        case CARD_REGISTRY.roa.id: return <ROACard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.roa} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.roa.id)} />;
        ...
        case CARD_REGISTRY.debt_to_equity.id: return <DebtToEquityCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.debt_to_equity} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.debt_to_equity.id)} />;
        case CARD_REGISTRY.interest_coverage.id: return <InterestCoverageCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.interest_coverage} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.interest_coverage.id)} />;
        ...
        case CARD_REGISTRY.current_ratio.id: return <CurrentRatioCard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.current_ratio} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.current_ratio.id)} />;
        ...
        case CARD_REGISTRY.fii.id: return <FIICard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.fii} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.fii.id)} />;
        case CARD_REGISTRY.dii.id: return <DIICard key={cardId} cardId={cardId} data={data} tradingMode={tradingMode} manualOverride={manualOverrides?.dii} lastUpdated={(isLive) => resolveTime(isLive, isLive ? null : CARD_REGISTRY.dii.id)} />;

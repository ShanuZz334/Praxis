...
export default function FundamentalHistoryChart({ trend = 'neutral', baseValue = 50, label = 'Metric' }) {
    ...
    if (safeTrend.includes('bull') || safeTrend.includes('top') || safeTrend.includes('high')) color = '#34d399';
    if (safeTrend.includes('bear') || safeTrend.includes('bottom') || safeTrend.includes('low')) color = '#f87171';

        ...
        ">
            ...
            ">
                ...
                <div className="flex items-center gap-3 mb-2 pb-2 border-b border-white/5">
                    <div className="w-6 h-6 rounded-md bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 text-emerald-400 text-xs">ℹ</div>
                    <span className="text-emerald-100/90 text-[11px] font-bold tracking-widest uppercase">Metric Guide</span>
                </div>
                ...
                <div className="bg-gradient-to-br from-white/[0.03] to-white/[0.01] rounded-xl p-4 border border-white/10 shadow-inner group transition-all hover:border-white/20">
                    <h3 className="text-[10px] font-extrabold text-emerald-400 uppercase tracking-widest mb-3 flex items-center gap-2">

...
export default function NiftyPBCard({ data, manualOverride, lastUpdated }) {
    ...
    const configData = getIndicatorConfig('nifty_pb');
    ...
    return (
        <IndicatorCard
            ...
            data={{
                currentValueObj: { label: 'Nifty P/B (x)', value: currentValue !== null ? (typeof currentValue === 'number' ? currentValue.toFixed(2) : currentValue) : '--' },
                details: [],
                score: score || 0,
                bias: bias || 'Neutral',

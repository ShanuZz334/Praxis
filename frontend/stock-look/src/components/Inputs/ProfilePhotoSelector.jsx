    ...
    <div className='flex justify-center mb-6'>
        ...
        {!image ? (
            <div className='w-20 h-20 flex items-center justify-center bg-purple-100 rounded-full relative'>
                ...
                <button type="button" className='w-8 h-8 flex items-center justify-center bg-purple-800 text-white rounded-full absolute -bottom-1 -right-1' onClick={onChooseFile}>
                    <LuUpload/>
                </button>
            </div>
        ) : (
